...
(brace
multiline_comment|/* Commit index as-is. */
...
multiline_comment|/* update the user index file */
id|add_files_to_cache
c_func
(paren
id|verbose
...
c_func
(paren
l_string|&quot;failed to read HEAD tree object&quot;
)paren
suffix:semicolon
)brace
multiline_comment|/* Use a lock file to garbage collect the temporary index file. */
id|next_index_lock
op_assign
id|xmalloc
c_func
...
l_string|&quot;# (Comment lines starting with &squot;#&squot; will not be included)&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
suffix:semicolon
multiline_comment|/* Start building up the commit header */
id|read_cache_from
c_func
(paren
id|index_file
...
suffix:semicolon
multiline_comment|/* Get the commit message and validate it */
id|header_len
op_assign
id|sb.len
suffix:semicolon
...
c_func
(paren
l_string|&quot;failed to write new index&quot;
)paren
suffix:semicolon
id|rerere
c_func
