...
suffix:semicolon
multiline_comment|/* pack+1 is the base sha1, unless we have it, we need to&n;&t; * unpack it first.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* pack+1 thru pack+20 is the base sha1 and&n;&t; * pack+21 thru unknown number is the delta data.&n;&t; * we do not even have size of the delta data uncompressed.&n;&t; * sheesh!&n;&t; */
id|delta_alloc
op_assign
l_int|1024
suffix:semicolon
...
c_func
(paren
l_string|&quot;failed to read delta-pack base object&quot;
)paren
suffix:semicolon
id|result
op_assign
