...
multiline_comment|/*&n; * Get the full path to the working tree specified in $GIT_WORK_TREE&n; * or NULL if no working tree is specified.&n; */
...
c_func
(paren
l_string|&quot;Cannot change directory to specified working tree &squot;%s&squot;&quot;
comma
id|git_work_tree
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* We do not spell &quot;group&quot; and such, so that&n;&t;&t; * the configuration can be read by older version&n;&t;&t; * of git.&n;&t;&t; */
id|sprintf
c_func
(paren
id|buf
