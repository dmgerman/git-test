...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * The first &squot;prefix&squot; characters of &squot;path&squot; are common leading&n;&t; * path components among the pathspecs we have seen so far,&n;&t; * including the trailing slash.&n;&t; */
id|prefix
op_assign
id|slash
id|path
