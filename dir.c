...
(brace
multiline_comment|/*&n;&t;&t; * NEEDSWORK: directory_exists_in_index_icase()&n;&t;&t; * assumes that one byte past the given path is&n;&t;&t; * readable and has &squot;/&squot;, which needs to be fixed, but&n;&t;&t; * until then, work it around in the caller.&n;&t;&t; */
id|strbuf_addch
c_func
(paren
id|path
