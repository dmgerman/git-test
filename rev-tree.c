...
mdefine_line|#define REACHABLE (1U &lt;&lt; 16)
DECL|macro|cmit_flags
mdefine_line|#define cmit_flags(cmit) ((cmit)-&gt;object.flags &amp; ~REACHABLE)
...
multiline_comment|/*&n;&t; * Parse all the commits in date order.&n;&t; *&n;&t; * We really should stop once we know enough, but that&squot;s a&n;&t; * decision that isn&squot;t trivial to make.&n;&t; */
r_while
c_loop
(paren
id|list
