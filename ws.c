...
c_func
(paren
l_string|&quot;tabwidth %.*s out of range&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;cannot enforce both tab-in-indent and indent-with-non-tab&quot;
)paren
suffix:semicolon
r_return
id|rule
...
multiline_comment|/* Copy the line onto the end of the strbuf while fixing whitespaces */
