...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Apply a filter to an fd only if the filter is required to succeed.&n;&t; * We must die if the filter fails, because the original data before&n;&t; * filtering is not available.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;%s: clean filter &squot;%s&squot; failed&quot;
comma
id|path
comma
id|ca.drv-&gt;name
...
c_func
(paren
l_string|&quot;%s: smudge filter %s failed&quot;
comma
id|path
comma
id|ca.drv-&gt;name
...
id|filter
suffix:semicolon
multiline_comment|/*&n;&t; * We may be holding onto the CR to see if it is followed by a&n;&t; * LF, in which case we would need to go to the main loop.&n;&t; * Otherwise, just emit it to the output stream.&n;&t; */
r_if
c_cond
(paren
id|lf_to_crlf-&gt;has_held
op_logical_and
(paren
id|lf_to_crlf-&gt;held
op_ne
...
(brace
multiline_comment|/*&n;&t;&t;&t;&t; * Previous round saw CR and it is not followed&n;&t;&t;&t;&t; * by a LF; emit the CR before processing the&n;&t;&t;&t;&t; * current character.&n;&t;&t;&t;&t; */
id|output
(braket
id|o
op_increment
...
multiline_comment|/*&n;&t;&t;&t; * We may have consumed the last output slot,&n;&t;&t;&t; * in which case we need to break out of this&n;&t;&t;&t; * loop; hold the current character before&n;&t;&t;&t; * returning.&n;&t;&t;&t; */
r_if
c_cond
(paren
op_star
...
r_continue
suffix:semicolon
multiline_comment|/* break but increment i */
)brace
r_if
c_cond
(paren
