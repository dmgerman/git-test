...
suffix:semicolon
multiline_comment|/*&n;&t; * If crlf is not mentioned, default to autocrlf;&n;&t; * disable autocrlf only when crlf attribute is explicitly&n;&t; * unset.&n;&t; */
r_return
(paren
op_logical_neg
id|git_checkattr
