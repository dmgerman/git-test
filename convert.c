...
multiline_comment|/*&n; * You would be crazy to set CRLF, smuge/clean or ident to&n; * a large binary blob you would want us not to slurp into&n; * the memory!&n; */
DECL|function|can_bypass_conversion
r_int
id|can_bypass_conversion
c_func
(paren
r_const
r_char
