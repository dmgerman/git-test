...
multiline_comment|/*&n; * Do we have HEAD in the output, and also the branch it points at?&n; * If so, find that decoration entry for that current branch.&n; */
...
id|rru_flags
suffix:semicolon
multiline_comment|/* First find HEAD */
r_for
c_loop
(paren
id|list
...
l_int|NULL
suffix:semicolon
multiline_comment|/* Now resolve and find the matching current branch */
id|branch_name
op_assign
...
r_else
(brace
multiline_comment|/*&n;&t;&t; * Each decoration has a refname in full; keep&n;&t;&t; * branch_name also in full, but still make sure&n;&t;&t; * HEAD is a reasonable ref.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* OK, do we have that ref in the list? */
r_for
c_loop
(paren
id|list
...
(brace
multiline_comment|/*&n;&t;&t; * When both current and HEAD are there, only&n;&t;&t; * show HEAD-&gt;current where HEAD would have&n;&t;&t; * appeared, skipping the entry for current.&n;&t;&t; */
r_if
c_cond
(paren
id|decoration
...
id|verify_message
comma
l_string|&quot;malformed mergetag&bslash;n&quot;
)paren
suffix:semicolon
r_else
r_if
...
id|verify_message
comma
l_string|&quot;merged tag &squot;%s&squot;&bslash;n&quot;
comma
id|tag-&gt;tag
)paren
suffix:semicolon
...
id|verify_message
comma
l_string|&quot;tag %s names a non-parent %s&bslash;n&quot;
comma
id|tag-&gt;tag
comma
id|tag-&gt;tagged-&gt;sha1
...
id|verify_message
comma
l_string|&quot;parent #%d, tagged &squot;%s&squot;&bslash;n&quot;
comma
id|nth
op_plus
l_int|1
...
c_cond
(paren
id|opt-&gt;from_ident.mail_begin
op_logical_and
id|opt-&gt;from_ident.name_begin
)paren
id|ctx.from_ident
op_assign
op_amp
