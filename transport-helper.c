...
id|helper
suffix:semicolon
multiline_comment|/*&n;&t; * Open the output as FILE* so strbuf_getline() can be used.&n;&t; * Do this with duped fd because fclose() will close the fd,&n;&t; * and stuff like taking over will require the fd to remain.&n;&t; *&n;&t; */
id|duped
op_assign
id|dup
c_func
