...
l_int|0
suffix:semicolon
multiline_comment|/* Count argv if needed. */
r_if
c_cond
(paren
id|count
...
multiline_comment|/* Special case: no argv. */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* Get destination buffer length. */
r_for
c_loop
(paren
id|i
...
l_int|1
suffix:semicolon
multiline_comment|/* Alloc destination buffer. */
id|to
op_assign
id|buf
op_assign
