...
(brace
DECL|macro|CHECK
mdefine_line|#define CHECK(x) (!want-&gt;x || (have-&gt;x &amp;&amp; !strcmp(want-&gt;x, have-&gt;x)))
r_return
id|CHECK
c_func
(paren
...
c_func
(paren
l_string|&quot;credential helper &squot;%s&squot; told us to quit&quot;
comma
id|c-&gt;helpers.items
(braket
id|i
