...
multiline_comment|/*&n;&t; * Use the external &quot;grep&quot; command for the case where&n;&t; * we grep through the checked-out files. It tends to&n;&t; * be a lot more optimized&n;&t; *&n;&t; * Some grep implementations do not understand -H nor --&n;&t; * but /dev/null can be used as a substitution in most&n;&t; * cases.&n;&t; *&n;&t; * However -L and -c would slightly misbehave (-L would&n;&t; * list /dev/null as a hit, and -c would report 0 hits&n;&t; * from /dev/null); so do not use the external one on&n;&t; * such platforms.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
