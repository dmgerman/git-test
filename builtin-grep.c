...
mdefine_line|#define looking_at(a,b) do {} while(0)
macro_line|#endif
r_static
r_struct
id|grep_expr
...
(brace
multiline_comment|/* Match beginning must be either&n;&t;&t; * beginning of the line, or at word&n;&t;&t; * boundary (i.e. the last char must&n;&t;&t; * not be alnum or underscore).&n;&t;&t; */
r_if
c_cond
(paren
(paren
