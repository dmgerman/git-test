...
suffix:semicolon
multiline_comment|/* Try an exact match first.  */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* Try with a wildcard match now.  */
r_if
c_cond
(paren
id|end
...
(brace
multiline_comment|/* Replace the star with the remote branch name.  */
id|nfasprintf
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * We do not have to check if we have enough space for&n;&t;&t; * the &squot;merge&squot; key, since it&squot;s shorter than the&n;&t;&t; * previous &squot;remote&squot; key, which we already checked.&n;&t;&t; */
id|snprintf
c_func
(paren
id|key
