...
id|child_to_clean
op_star
id|children_to_clean
suffix:semicolon
DECL|variable|installed_child_cleanup_handler
r_static
r_int
id|installed_child_cleanup_handler
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* no asyncs started yet */
r_return
op_logical_neg
id|pthread_equal
c_func
...
DECL|macro|atexit
mdefine_line|#define atexit git_atexit
...
suffix:semicolon
multiline_comment|/* throw away exit code */
r_return
l_int|1
suffix:semicolon
)brace
