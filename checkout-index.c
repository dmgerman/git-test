...
op_assign
l_string|&quot;git-checkout-index [-u] [-q] [-a] [-f] [-n] [--stage=[123]] [--prefix=&lt;string&gt;] [--] &lt;file&gt;...&quot;
suffix:semicolon
...
c_func
(paren
l_string|&quot;stage should be between 1 and 3&quot;
)paren
suffix:semicolon
r_continue
suffix:semicolon
