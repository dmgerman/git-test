...
l_int|0
suffix:semicolon
multiline_comment|/*&n; * update-cache --refresh may not touch anything at all, in which case&n; * writing 1.6MB of the same thing is a waste.&n; */
...
(brace
multiline_comment|/* If we have not smudged the cache, be careful&n;&t;&t; * to keep it clean.  Find out if we have a matching&n;&t;&t; * cache entry that add_cache_entry would replace with,&n;&t;&t; * and if it matches then do not bother calling it.&n;&t;&t; */
r_int
id|pos
op_assign
id|cache_name_pos
...
suffix:semicolon
multiline_comment|/* magic to tell add_file_to_cache that&n;&t;&t;&t; * we have not updated anything.&n;&t;&t;&t; */
r_return
l_int|999
suffix:semicolon
)brace
