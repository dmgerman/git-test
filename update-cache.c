...
(brace
multiline_comment|/*&n;&t; * This is really not the right way to do it, but&n;&t; * add_file_to_cache() does do the right thing.&n;&t; *&n;&t; * We should really just update the cache&n;&t; * entry in-place, I think. With this approach we&n;&t; * end up allocating a new one, searching for where&n;&t; * to insert it etc etc crud.&n;&t; */
id|add_file_to_cache
c_func
(paren
id|ce-&gt;name
