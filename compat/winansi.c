...
(brace
multiline_comment|/* get original console handle */
r_int
id|fd
op_assign
id|_fileno
...
c_func
(paren
l_string|&quot;_get_osfhandle(%i) failed&quot;
comma
id|fd
)paren
suffix:semicolon
multiline_comment|/* save a copy to phcon and console (used by the background thread) */
id|console
op_assign
op_star
id|phcon
...
suffix:semicolon
multiline_comment|/* duplicate new_fd over fd (closes fd and associated handle (hcon)) */
r_if
c_cond
(paren
id|_dup2
...
suffix:semicolon
multiline_comment|/* no buffering, or stdout / stderr will be out of sync */
id|setbuf
c_func
(paren
id|stream
...
suffix:semicolon
multiline_comment|/* create a file descriptor for the write end of the pipe */
id|hwrite_fd
op_assign
id|_open_osfhandle
c_func
...
c_func
(paren
l_string|&quot;_open_osfhandle(%li) failed&quot;
comma
(paren
r_int
)paren
...
suffix:semicolon
multiline_comment|/* close pipe file descriptor (also closes the duped hwrite) */
id|close
c_func
(paren
id|hwrite_fd
...
multiline_comment|/*&n; * Return true if stdout / stderr is a pipe redirecting to the console.&n; */
