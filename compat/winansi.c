...
c_func
(paren
l_string|&quot;Your console font probably doesn&bslash;&squot;t support Unicode. If &quot;
l_string|&quot;you experience strange characters in the output, consider &quot;
l_string|&quot;switching to a TrueType font such as Lucida Console!&quot;
)paren
suffix:semicolon
)brace
...
id|pGetCurrentConsoleFontEx
suffix:semicolon
multiline_comment|/* don&squot;t do this twice */
r_if
c_cond
(paren
id|truetype_font_checked
...
l_int|0
suffix:semicolon
multiline_comment|/* use cached value if stream hasn&squot;t changed */
r_if
c_cond
(paren
id|stream
...
l_int|NULL
suffix:semicolon
multiline_comment|/* get OS handle of the stream */
id|hcon
op_assign
(paren
id|HANDLE
...
suffix:semicolon
multiline_comment|/*&n;&t; * if non-ascii characters are printed, check that the current console&n;&t; * font supports this&n;&t; */
r_if
c_cond
(paren
id|wlen
