...
(brace
multiline_comment|/*&n;&t; * For remove_name_hash, find the exact entry (pointer equality); for&n;&t; * index_name_exists, find all entries with matching hash code and&n;&t; * decide whether the entry matches in same_name.&n;&t; */
r_return
id|remove
ques
c_cond
