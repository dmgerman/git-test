...
r_break
suffix:semicolon
multiline_comment|/* End of string and all is good */
)brace
r_else
(brace
id|sl
...
suffix:semicolon
multiline_comment|/* read_packet_line can return embedded &bslash;0 */
r_for
c_loop
(paren
id|pp
...
c_func
(paren
l_string|&quot;Forbidden directory: %s&bslash;n&quot;
comma
id|dir
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Not a valid git-daemon-enabled repository: &squot;%s&squot;&quot;
comma
id|dir
)paren
suffix:semicolon
