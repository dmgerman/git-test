...
suffix:semicolon
multiline_comment|/* because of symlinks we must match both what the&n;&t;&t;&t; * user passed and the canonicalized path, otherwise&n;&t;&t;&t; * the user can send a string matching either a whitelist&n;&t;&t;&t; * entry or an actual directory exactly and still not&n;&t;&t;&t; * get through */
r_if
c_cond
(paren
id|len
...
c_func
(paren
l_string|&quot;git-daemon: option --strict-paths requires a whitelist&quot;
)paren
suffix:semicolon
id|logerror
c_func
