...
suffix:semicolon
multiline_comment|/* The validation is done on the paths after enter_repo&n;&t;&t; * canonicalization, so whitelist should be written in&n;&t;&t; * terms of real pathnames (i.e. after ~user is expanded&n;&t;&t; * and symlinks resolved).&n;&t;&t; */
r_for
c_loop
(paren
id|pp
