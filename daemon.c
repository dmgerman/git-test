...
id|timeout
suffix:semicolon
multiline_comment|/*&n;&t;&t; * This 1-sec timeout could lead to idly looping but it is&n;&t;&t; * here so that children culled in child_handler() are reported&n;&t;&t; * without too much delay.  We could probably set up a pipe&n;&t;&t; * to ourselves that we poll, and write to the fd from child_handler()&n;&t;&t; * to wake us up (and consume it when the poll() returns...&n;&t;&t; */
id|timeout
op_assign
(paren
id|children_spawned
