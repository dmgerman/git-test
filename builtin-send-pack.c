...
multiline_comment|/* a return value of -1 indicates that an error occurred,&n; * but we were able to set individual ref errors. A return&n; * value of -2 means we couldn&squot;t even get that far. */
