...
multiline_comment|/*&n;&t; * Check that everything that we try to reference is also good.&n;&t; */
id|refs
op_assign
...
id|stderr
comma
l_string|&quot;Checking tree %s&bslash;n&quot;
comma
id|sha1_to_hex
c_func
(paren
...
id|stderr
comma
l_string|&quot;Checking commit %s&bslash;n&quot;
comma
id|sha1_to_hex
c_func
(paren
...
id|stderr
comma
l_string|&quot;Checking tag %s&bslash;n&quot;
comma
id|sha1_to_hex
c_func
(paren
...
l_string|&quot;[--strict] [--verbose] &lt;head-sha1&gt;*]&quot;
suffix:semicolon
