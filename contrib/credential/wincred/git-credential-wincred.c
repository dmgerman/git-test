...
id|WINAPI
op_star
id|CredUnPackAuthenticationBufferWT
)paren
(paren
id|DWORD
comma
...
id|WINAPI
op_star
id|CredPackAuthenticationBufferWT
)paren
(paren
id|DWORD
comma
...
r_static
id|CredUnPackAuthenticationBufferWT
id|CredUnPackAuthenticationBufferW
suffix:semicolon
...
r_static
id|CredPackAuthenticationBufferWT
id|CredPackAuthenticationBufferW
suffix:semicolon
...
id|credui
comma
l_string|&quot;CredUnPackAuthenticationBufferW&quot;
)paren
suffix:semicolon
id|CredEnumerateW
op_assign
...
id|credui
comma
l_string|&quot;CredPackAuthenticationBufferW&quot;
)paren
suffix:semicolon
id|CredFree
op_assign
...
c_func
(paren
l_string|&quot;CredUnPackAuthenticationBuffer failed&quot;
)paren
suffix:semicolon
id|CredFree
c_func
...
suffix:semicolon
multiline_comment|/* zero-terminate (sizes include zero-termination) */
id|user_buf
(braket
id|user_buf_size
l_int|1
...
l_int|1
suffix:semicolon
multiline_comment|/* store zero-termination */
id|attr-&gt;Value
op_assign
(paren
id|LPBYTE
...
r_return
suffix:semicolon
multiline_comment|/* query buffer size */
id|CredPackAuthenticationBufferW
c_func
(paren
l_int|0
...
c_func
(paren
l_string|&quot;CredPackAuthenticationBuffer failed&quot;
)paren
suffix:semicolon
id|cred.Flags
op_assign
