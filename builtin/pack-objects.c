...
multiline_comment|/* Enough space for &quot;-&lt;sha-1&gt;.pack&quot;? */
r_if
c_cond
(paren
r_sizeof
...
c_func
(paren
l_string|&quot;pack base name &squot;%s&squot; too long&quot;
comma
id|base_name
)paren
suffix:semicolon
...
id|stderr
comma
l_string|&quot;Reusing existing pack: %d, done.&bslash;n&quot;
comma
id|reuse_packfile_objects
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;option %s does not accept negative form&quot;
)paren
comma
id|opt-&gt;long_name
)paren
...
c_func
(paren
l_string|&quot;unable to parse value &squot;%s&squot; for option %s&quot;
)paren
comma
id|arg
comma
...
mdefine_line|#define OPT_ULONG(s, l, v, h) &bslash;&n;&t;{ OPTION_CALLBACK, (s), (l), (v), &quot;n&quot;, (h),&t;&bslash;&n;&t;  PARSE_OPT_NONEG, option_parse_ulong }
