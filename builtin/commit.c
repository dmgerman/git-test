...
c_func
(paren
l_string|&quot;BUG: unable to parse our own ident: %s&quot;
comma
id|buf-&gt;buf
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;commit &squot;%s&squot; lacks author header&quot;
)paren
comma
id|author_message
)paren
...
c_func
(paren
l_string|&quot;commit &squot;%s&squot; has malformed author line&quot;
)paren
comma
id|author_message
)paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * These should never fail because they come from our own&n;&t;&t; * fmt_ident. They may fail the sane_ident test, but we know&n;&t;&t; * that the name and mail pointers will at least be valid,&n;&t;&t; * which is enough for our tests and printing here.&n;&t;&t; */
id|assert_split_ident
c_func
(paren
op_amp
