...
multiline_comment|/*&n; * Inspect sb and determine the true &quot;end&quot; of the log message, in&n; * order to find where to put a new Signed-off-by: line.  Ignored are&n; * trailing &quot;Conflict:&quot; block.&n; *&n; * Returns the number of bytes from the tail to ignore, to be fed as&n; * the second parameter to append_signoff().&n; */
