...
c_func
(paren
l_string|&quot;set From address to &lt;ident&gt; (or committer ident if absent)&quot;
)paren
comma
id|PARSE_OPT_OPTARG
comma
...
c_func
(paren
l_string|&quot;add a signature from a file&quot;
)paren
)paren
comma
id|OPT__QUIET
...
(brace
suffix:semicolon
multiline_comment|/* --no-signature inhibits all signatures */
)brace
r_else
r_if
c_cond
...
(brace
suffix:semicolon
multiline_comment|/* non-default signature already set */
)brace
r_else
r_if
c_cond
...
c_func
(paren
l_string|&quot;unable to read signature file &squot;%s&squot;&quot;
)paren
comma
id|signature_file
)paren
