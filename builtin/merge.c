...
id|head
op_assign
id|head_commit-&gt;object.oid.hash
suffix:semicolon
r_if
c_cond
(paren
...
c_func
(paren
id|remote_head-&gt;object.oid.hash
)paren
comma
id|truname.buf
op_plus
...
id|msg
comma
l_string|&quot;%s&bslash;t&bslash;t%s &squot;%s&squot;&bslash;n&quot;
comma
id|sha1_to_hex
c_func
(paren
...
c_func
(paren
id|second_token-&gt;object.oid.hash
comma
id|head
)paren
)paren
...
multiline_comment|/* an explicit -m msg without --[no-]edit */
r_return
l_int|0
suffix:semicolon
r_if
...
c_func
(paren
l_string|&quot;Bad value &squot;%s&squot; in environment &squot;%s&squot;&quot;
comma
id|e
comma
id|name
...
multiline_comment|/* Use editor if stdin and stdout are the same and is a tty */
r_return
(paren
op_logical_neg
id|fstat
...
c_func
(paren
l_string|&quot;could not close &squot;%s&squot;&quot;
)paren
comma
id|filename
)paren
...
r_continue
suffix:semicolon
multiline_comment|/* not-for-merge */
r_else
(brace
r_char
id|saved
...
c_func
(paren
l_string|&quot;not something we can merge in %s: %s&quot;
comma
id|filename
comma
id|merge_names-&gt;buf
...
c_func
(paren
l_string|&quot;Commit %s has a bad GPG signature &quot;
l_string|&quot;allegedly by %s.&quot;
)paren
comma
id|hex
...
r_default
suffix:colon
multiline_comment|/* &squot;N&squot; */
id|die
c_func
(paren
id|_
c_func
(paren
l_string|&quot;Commit %s does not have a GPG signature.&quot;
)paren
comma
id|hex
)paren
...
c_func
(paren
l_string|&quot;Commit %s has a good GPG signature by %s&bslash;n&quot;
)paren
comma
id|hex
comma
...
suffix:semicolon
multiline_comment|/* already up-to-date */
r_else
r_if
c_cond
(paren
...
c_func
(paren
id|common-&gt;item-&gt;object.oid.hash
comma
id|head_commit-&gt;object.oid.hash
)paren
)paren
...
id|to
comma
id|remoteheads-&gt;item-&gt;object.oid.hash
comma
id|DEFAULT_ABBREV
)paren
suffix:semicolon
...
c_func
(paren
id|common_one-&gt;item-&gt;object.oid.hash
comma
id|j-&gt;item-&gt;object.oid.hash
)paren
)paren
(brace
id|up_to_date
