...
l_int|0
suffix:semicolon
multiline_comment|/* stop searching if we go too far back in time */
r_if
c_cond
(paren
id|candidate-&gt;date
...
l_int|0
suffix:semicolon
multiline_comment|/* Otherwise recurse and mark ourselves for future traversals. */
r_for
c_loop
(paren
id|p
