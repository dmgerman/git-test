...
multiline_comment|/*&n; * Porcelain/Incremental format wants to show a lot of details per&n; * commit.  Instead of repeating this every line, emit it only once,&n; * the first time each commit appears in the output.&n; */
