...
l_int|NULL
suffix:semicolon
multiline_comment|/* We have already decided to ignore this item */
r_if
c_cond
(paren
op_logical_neg
...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n;&t; * For all the tags in the remote_refs string list, call&n;&t; * add_to_tail to add them to the list of refs to be fetched&n;&t; */
