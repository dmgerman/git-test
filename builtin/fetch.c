...
multiline_comment|/*&n; * Take callback data, and return next object name in the buffer.&n; * When called after returning the name for the last object, return -1&n; * to signal EOF, otherwise return 0.&n; */
