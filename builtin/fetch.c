...
(brace
multiline_comment|/*&n;&t;&t;&t; * --tags was specified.  Pretend that the user also&n;&t;&t;&t; * gave us the canonical tags refspec&n;&t;&t;&t; */
r_const
r_char
op_star
id|tags_str
op_assign
l_string|&quot;refs/tags/*:refs/tags/*&quot;
suffix:semicolon
r_struct
id|refspec
op_star
...
id|refspec
suffix:semicolon
multiline_comment|/* Copy the refspec and add the tags to it */
id|refspec
op_assign
id|xcalloc
c_func
...
suffix:semicolon
multiline_comment|/* The rest of the strings belong to fetch_one */
id|free_refspec
c_func
(paren
l_int|1
