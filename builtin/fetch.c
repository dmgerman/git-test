...
multiline_comment|/*&n;&t; * The first pass writes objects to be merged and then the&n;&t; * second pass writes the rest, in order to allow using&n;&t; * FETCH_HEAD as a refname to refer to the ref to be merged.&n;&t; */
r_for
c_loop
(paren
id|want_merge
