...
c_func
(paren
l_string|&quot;Directory %s is in index and no submodule?&quot;
)paren
comma
id|src
)paren
...
r_else
(brace
multiline_comment|/* last - first &gt;= 1 */
r_int
id|j
comma
id|dst_len
