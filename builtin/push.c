...
l_int|NULL
suffix:semicolon
multiline_comment|/* Does &quot;ref&quot; uniquely name our ref? */
r_if
c_cond
(paren
...
(brace
multiline_comment|/* lazily grab remote and local_refs */
id|remote
op_assign
id|remote_get
c_func
...
c_func
(paren
l_string|&quot;underlying transport does not support --%s option&quot;
comma
id|CAS_OPT_NAME
)paren
suffix:semicolon
...
id|k
comma
l_string|&quot;push.recursesubmodules&quot;
)paren
)paren
(brace
r_const
...
suffix:semicolon
r_int
id|recurse_submodules_from_cmdline
op_assign
id|RECURSE_SUBMODULES_DEFAULT
suffix:semicolon
r_int
