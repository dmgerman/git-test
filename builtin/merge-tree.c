...
r_return
suffix:semicolon
multiline_comment|/* there is no tree here */
id|newbase
op_assign
id|traverse_path
c_func
...
mdefine_line|#define ENTRY_SHA1(e) (((e)-&gt;mode &amp;&amp; S_ISDIR((e)-&gt;mode)) ? (e)-&gt;sha1 : NULL)
id|buf0
op_assign
...
(brace
multiline_comment|/* Modified, added or removed identically */
id|resolve
c_func
(paren
id|info
...
(brace
multiline_comment|/* We added, modified or removed, they did not touch -- take ours */
id|resolve
c_func
(paren
id|info
