...
op_assign
l_string|&quot;&bslash;nWrite/edit the notes for the following object:&bslash;n&quot;
suffix:semicolon
...
c_func
(paren
l_string|&quot;could not read &squot;show&squot; output&quot;
)paren
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Please supply the note contents using either -m or -F option&quot;
)paren
)paren
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;Cannot read note data from non-blob object &squot;%s&squot;.&quot;
)paren
comma
id|arg
)paren
...
id|t
comma
l_string|&quot;Notes added by &squot;git notes add&squot;&quot;
)paren
suffix:semicolon
)brace
r_else
...
id|t
comma
l_string|&quot;Notes removed by &squot;git notes add&squot;&quot;
)paren
suffix:semicolon
)brace
id|free_note_data
...
comma
l_string|&quot;Notes added by &squot;git notes %s&squot;&quot;
comma
id|argv
(braket
l_int|0
...
comma
l_string|&quot;Notes removed by &squot;git notes %s&squot;&quot;
comma
id|argv
(braket
l_int|0
...
r_static
r_int
id|git_config_get_notes_strategy
c_func
(paren
r_const
r_char
...
id|key
comma
l_string|&quot;unknown notes merge strategy %s&quot;
comma
id|value
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;BUG: local ref %s is outside of refs/notes/&quot;
comma
id|o.local_ref
)paren
suffix:semicolon
...
id|merge_key
comma
l_string|&quot;notes.%s.mergeStrategy&quot;
comma
id|short_ref
)paren
suffix:semicolon
