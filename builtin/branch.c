...
mdefine_line|#define REF_DETACHED_HEAD   0x01
DECL|macro|REF_LOCAL_BRANCH
mdefine_line|#define REF_LOCAL_BRANCH    0x02
DECL|macro|REF_REMOTE_BRANCH
mdefine_line|#define REF_REMOTE_BRANCH   0x04
DECL|variable|head
r_static
r_const
r_char
...
suffix:semicolon
multiline_comment|/*  If detached the first ref_item is the current ref */
r_if
c_cond
(paren
id|detached
