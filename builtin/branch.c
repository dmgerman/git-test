...
multiline_comment|/*&n; * Allocate memory for a new ref_array_item and insert that into the&n; * given ref_array. Doesn&squot;t take the objectname unlike&n; * new_ref_array_item(). This is a temporary function which will be&n; * removed when we port branch.c to use ref-filter APIs.&n; */
