...
id|filter_stage
suffix:semicolon
multiline_comment|/* still reading log or are we copying patch? */
...
id|remove
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * If the input had a space after the ], keep&n;&t;&t;&t;&t; * it.  We don&squot;t bother with finding the end of&n;&t;&t;&t;&t; * the space, since we later normalize it&n;&t;&t;&t;&t; * anyway.&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|isspace
...
c_func
(paren
id|mi-&gt;log_message.buf
comma
l_int|1
comma
id|mi-&gt;log_message.len
comma
id|cmitmsg
)paren
suffix:semicolon
