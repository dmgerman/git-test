...
multiline_comment|/*&n; * If the git_dir is not directly inside the working tree, then git will not&n; * find it by default, and we need to set the worktree explicitly.&n; */
DECL|function|needs_work_tree_config
r_static
r_int
id|needs_work_tree_config
c_func
(paren
r_const
r_char
