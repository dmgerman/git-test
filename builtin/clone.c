...
id|dir
suffix:semicolon
multiline_comment|/*&n;&t; * Skip scheme.&n;&t; */
id|start
op_assign
id|strstr
c_func
...
l_int|3
suffix:semicolon
multiline_comment|/*&n;&t; * Skip authentication data. The stripping does happen&n;&t; * greedily, such that we strip up to the last &squot;@&squot; inside&n;&t; * the host part.&n;&t; */
r_for
c_loop
(paren
id|ptr
...
multiline_comment|/*&n;&t; * Strip trailing port number if we&squot;ve got only a&n;&t; * hostname (that is, there is no dir separator but a&n;&t; * colon). This check is required such that we do not&n;&t; * strip URI&squot;s like &squot;/foo/bar:2222.git&squot;, which should&n;&t; * result in a dir &squot;2222&squot; being guessed due to backwards&n;&t; * compatibility.&n;&t; */
r_if
c_cond
(paren
id|memchr
...
multiline_comment|/*&n;&t; * Find last component. To remain backwards compatible we&n;&t; * also regard colons as path separators, such that&n;&t; * cloning a repository &squot;foo:bar.git&squot; would result in a&n;&t; * directory &squot;bar&squot; being guessed.&n;&t; */
id|ptr
op_assign
id|end
suffix:semicolon
...
id|STRBUF_INIT
suffix:semicolon
multiline_comment|/* Beware: read_gitfile(), real_path() and mkpath() return static buffer */
id|ref_git
op_assign
id|xstrdup
c_func
...
c_func
(paren
l_string|&quot;reference repository &squot;%s&squot; as a linked checkout is not supported yet.&quot;
)paren
comma
id|item-&gt;string
)paren
...
c_func
(paren
l_string|&quot;reference repository &squot;%s&squot; is shallow&quot;
)paren
comma
id|item-&gt;string
)paren
...
c_func
(paren
l_string|&quot;reference repository &squot;%s&squot; is grafted&quot;
)paren
comma
id|item-&gt;string
)paren
...
c_func
(paren
l_string|&quot;Clone succeeded, but checkout failed.&bslash;n&quot;
l_string|&quot;You can inspect what was checked out with &squot;git status&squot;&bslash;n&quot;
l_string|&quot;and retry the checkout with &squot;git checkout -f HEAD&squot;&bslash;n&quot;
)paren
suffix:semicolon
...
r_default
suffix:colon
multiline_comment|/* proceed to removal */
r_break
suffix:semicolon
)brace
r_if
...
suffix:semicolon
multiline_comment|/* if --branch=tag, pull the requested tag explicitly */
id|get_fetch_map
c_func
(paren
id|remote_head
...
id|rm
suffix:semicolon
multiline_comment|/*&n;&t; * Skip anything missing a peer_ref, which we are not&n;&t; * actually going to write a ref for.&n;&t; */
r_while
c_loop
(paren
id|ref
...
id|ref-&gt;next
suffix:semicolon
multiline_comment|/* Returning -1 notes &quot;end of list&quot; to the caller. */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;BUG: remote HEAD points at non-head?&quot;
)paren
suffix:semicolon
id|strbuf_addf
c_func
...
c_func
(paren
l_string|&quot;cannot repack to clean up&quot;
)paren
)paren
suffix:semicolon
r_if
...
c_func
(paren
l_string|&quot;cannot unlink temporary alternates file&quot;
)paren
)paren
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;--dissociate given, but there is no --reference&quot;
)paren
)paren
suffix:semicolon
id|option_dissociate
...
c_func
(paren
l_string|&quot;source repository is shallow, ignoring --local&quot;
)paren
)paren
suffix:semicolon
id|is_local
