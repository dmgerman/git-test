...
c_func
(paren
l_string|&quot;git cat-file: could not get object info&quot;
)paren
suffix:semicolon
r_if
c_cond
...
id|mark_query
suffix:semicolon
multiline_comment|/*&n;&t; * Whether to split the input on whitespace before feeding it to&n;&t; * get_sha1; this is decided during the mark_query phase based on&n;&t; * whether we have a %(rest) token in our format.&n;&t; */
DECL|member|split_on_whitespace
r_int
id|split_on_whitespace
suffix:semicolon
...
id|data-&gt;info.delta_base_sha1
op_assign
id|data-&gt;delta_base_sha1
suffix:semicolon
r_else
id|strbuf_addstr
c_func
...
c_func
(paren
l_string|&quot;unable to write to stdout&quot;
)paren
suffix:semicolon
)brace
r_else
...
c_func
(paren
l_string|&quot;object %s changed size!?&quot;
comma
id|sha1_to_hex
c_func
(paren
...
c_func
(paren
l_string|&quot;BUG: unknown get_sha1_with_context result %d&bslash;n&quot;
comma
id|result
)paren
suffix:semicolon
...
id|ctx.symlink_path.len
comma
id|ctx.symlink_path.buf
)paren
suffix:semicolon
id|fflush
c_func
...
(brace
multiline_comment|/*&n;&t;&t;&t; * Split at first whitespace, tying off the beginning&n;&t;&t;&t; * of the string and saving the remainder (or NULL) in&n;&t;&t;&t; * data.rest.&n;&t;&t;&t; */
r_char
op_star
id|p
op_assign
...
c_func
(paren
l_string|&quot;git cat-file (-t [--allow-unknown-type]|-s [--allow-unknown-type]|-e|-p|&lt;type&gt;|--textconv) &lt;object&gt;&quot;
)paren
comma
id|N_
c_func
...
c_func
(paren
l_string|&quot;allow -s and -t to work with broken/corrupt objects&quot;
)paren
)paren
comma
id|OPT_BOOL
...
comma
op_amp
id|batch.buffer_output
comma
id|N_
c_func
(paren
l_string|&quot;buffer --batch output&quot;
)paren
)paren
comma
(brace
...
l_int|0
comma
l_string|&quot;follow-symlinks&quot;
comma
op_amp
id|batch.follow_symlinks
comma
id|N_
c_func
(paren
l_string|&quot;follow in-tree symlinks (used with --batch or --batch-check)&quot;
)paren
)paren
comma
id|OPT_BOOL
...
l_int|0
comma
l_string|&quot;batch-all-objects&quot;
comma
op_amp
id|batch.all_objects
comma
id|N_
c_func
(paren
l_string|&quot;show all objects with --batch or --batch-check&quot;
)paren
)paren
comma
id|OPT_END
...
c_func
(paren
l_string|&quot;git cat-file --allow-unknown-type: use with -s or -t&quot;
)paren
suffix:semicolon
r_return
id|cat_one_file
