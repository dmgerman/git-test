...
(brace
multiline_comment|/*&n;&t;&t; * Just &quot;..&quot;?  That is not a range but the&n;&t;&t; * pathspec for the parent directory.&n;&t;&t; */
op_star
id|dotdot
op_assign
l_char|&squot;.&squot;
...
multiline_comment|/* parse: (&lt;short&gt;|&lt;short&gt;,&lt;long&gt;|&lt;long&gt;)[*=?!]*&lt;arghint&gt;? SP+ &lt;help&gt; */
r_while
c_loop
(paren
id|strbuf_getline
...
id|parseopt_dump
suffix:semicolon
multiline_comment|/* Possible argument name hint */
id|end
op_assign
id|s
suffix:semicolon
...
c_func
(paren
l_string|&quot;--git-path requires an argument&quot;
)paren
suffix:semicolon
id|puts
c_func
...
c_func
(paren
l_string|&quot;--default requires an argument&quot;
)paren
suffix:semicolon
r_continue
suffix:semicolon
...
c_func
(paren
l_string|&quot;--prefix requires an argument&quot;
)paren
suffix:semicolon
id|startup_info-&gt;prefix
op_assign
...
c_func
(paren
l_string|&quot;--resolve-git-dir requires an argument&quot;
)paren
suffix:semicolon
id|gitdir
op_assign
