...
mdefine_line|#define REFNAME_ALLOW_ONELEVEL 1
DECL|macro|REFNAME_REFSPEC_PATTERN
mdefine_line|#define REFNAME_REFSPEC_PATTERN 2
...
c_func
(paren
l_string|&quot;internal error: unexpected value from check_ref_format()&quot;
)paren
suffix:semicolon
)brace
r_if
