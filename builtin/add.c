...
id|pathspec
suffix:semicolon
multiline_comment|/*&n;&t; * git-add--interactive itself does not parse pathspec. It&n;&t; * simply passes the pathspec to other builtin commands. Let&squot;s&n;&t; * hope all of them support all magic, or we&squot;ll need to limit&n;&t; * the magic here. There is still a problem with prefix. But&n;&t; * that&squot;ll be worked on later on.&n;&t; */
id|parse_pathspec
c_func
(paren
op_amp
