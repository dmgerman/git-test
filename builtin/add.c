...
id|implicit_dot
op_assign
id|data-&gt;implicit_dot
suffix:semicolon
r_int
id|implicit_dot_len
op_assign
id|data-&gt;implicit_dot_len
suffix:semicolon
r_for
c_loop
(paren
...
id|p-&gt;one-&gt;path
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Check if &quot;git add -A&quot; or &quot;git add -u&quot; was run from a&n;&t;&t; * subdirectory with a modified file outside that directory,&n;&t;&t; * and warn if so.&n;&t;&t; *&n;&t;&t; * &quot;git add -u&quot; will behave like &quot;git add -u :/&quot; instead of&n;&t;&t; * &quot;git add -u .&quot; in the future.  This warning prepares for&n;&t;&t; * that change.&n;&t;&t; */
r_if
c_cond
(paren
id|implicit_dot
...
multiline_comment|/*&n; * Checks the index to see whether any path in pathspec refers to&n; * something inside a submodule.  If so, dies with an error message.&n; */
...
multiline_comment|/*&n; * Normalizes argv relative to prefix, via get_pathspec(), and then&n; * runs die_if_path_beyond_symlink() on each path in the normalized&n; * list.&n; */
...
(brace
multiline_comment|/*&n;&t;&t; * Check for modified files throughout the worktree so&n;&t;&t; * update_callback has a chance to warn about changes&n;&t;&t; * outside the cwd.&n;&t;&t; */
id|update_data.implicit_dot
op_assign
id|prefix
suffix:semicolon
id|update_data.implicit_dot_len
op_assign
id|strlen
c_func
(paren
