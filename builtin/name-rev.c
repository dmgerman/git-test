...
comma
(brace
multiline_comment|/* A Hidden OPT_BOOL */
id|OPTION_SET_INT
comma
l_int|0
comma
...
c_func
(paren
l_string|&quot;dereference tags in the input (internal use)&quot;
)paren
comma
id|PARSE_OPT_NOARG
op_or
...
id|stderr
comma
l_string|&quot;Could not get object for %s. Skipping.&bslash;n&quot;
comma
op_star
id|argv
)paren
