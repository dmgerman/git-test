...
suffix:semicolon
multiline_comment|/**&n; * Parses the value of --rebase. If value is a false value, returns&n; * REBASE_FALSE. If value is a true value, returns REBASE_TRUE. If value is&n; * &quot;preserve&quot;, returns REBASE_PRESERVE. If value is a invalid value, dies with&n; * a fatal error if fatal is true, otherwise returns REBASE_INVALID.&n; */
DECL|function|parse_config_rebase
r_static
r_enum
id|rebase_type
id|parse_config_rebase
c_func
(paren
r_const
r_char
...
multiline_comment|/**&n; * Callback for --rebase, which parses arg with parse_config_rebase().&n; */
...
id|opt_progress
suffix:semicolon
multiline_comment|/* Options passed to git-merge or git-rebase */
...
c_func
(paren
l_string|&quot;incorporate changes by rebasing rather than merging&quot;
)paren
comma
id|PARSE_OPT_OPTARG
comma
...
multiline_comment|/**&n; * Sets the GIT_REFLOG_ACTION environment variable to the concatenation of argv&n; */
...
multiline_comment|/**&n; * Returns the default configured value for --rebase. It first looks for the&n; * value of &quot;branch.$curr_branch.rebase&quot;, where $curr_branch is the current&n; * branch, and if HEAD is detached or the configuration key does not exist,&n; * looks for the value of &quot;pull.rebase&quot;. If both configuration keys do not&n; * exist, returns REBASE_FALSE.&n; */
DECL|function|config_get_rebase
r_static
r_enum
id|rebase_type
id|config_get_rebase
c_func
(paren
r_void
)paren
...
multiline_comment|/**&n; * Returns 1 if there are unstaged changes, 0 otherwise.&n; */
DECL|function|has_unstaged_changes
r_static
r_int
id|has_unstaged_changes
c_func
(paren
r_const
r_char
...
multiline_comment|/**&n; * Returns 1 if there are uncommitted changes, 0 otherwise.&n; */
DECL|function|has_uncommitted_changes
r_static
r_int
id|has_uncommitted_changes
c_func
(paren
r_const
r_char
...
multiline_comment|/**&n; * If the work tree has unstaged or uncommitted changes, dies with the&n; * appropriate message.&n; */
DECL|function|die_on_unclean_work_tree
r_static
r_void
id|die_on_unclean_work_tree
c_func
(paren
r_const
r_char
...
c_func
(paren
l_string|&quot;Cannot pull with rebase: You have unstaged changes.&quot;
)paren
)paren
suffix:semicolon
id|do_die
...
c_func
(paren
l_string|&quot;Additionally, your index contains uncommitted changes.&quot;
)paren
)paren
suffix:semicolon
r_else
...
c_func
(paren
l_string|&quot;Cannot pull with rebase: Your index contains uncommitted changes.&quot;
)paren
)paren
suffix:semicolon
id|do_die
...
c_func
(paren
l_string|&quot;There is no candidate for rebasing against among the refs that you just fetched.&quot;
)paren
)paren
suffix:semicolon
r_else
...
c_func
(paren
l_string|&quot;Please specify which branch you want to rebase against.&quot;
)paren
)paren
suffix:semicolon
r_else
...
multiline_comment|/**&n; * Returns remote&squot;s upstream branch for the current branch. If remote is NULL,&n; * the current branch&squot;s configured default remote is used. Returns NULL if&n; * `remote` does not name a valid remote, HEAD does not point to a branch,&n; * remote is not the branch&squot;s configured remote or the branch does not have any&n; * configured upstream branch.&n; */
...
multiline_comment|/**&n; * Derives the remote tracking branch from the remote and refspec.&n; *&n; * FIXME: The current implementation assumes the default mapping of&n; * refs/heads/&lt;branch_name&gt; to refs/remotes/&lt;remote_name&gt;/&lt;branch_name&gt;.&n; */
DECL|function|get_tracking_branch
r_static
r_const
r_char
op_star
id|get_tracking_branch
c_func
(paren
r_const
r_char
...
multiline_comment|/**&n; * Given the repo and refspecs, sets fork_point to the point at which the&n; * current branch forked from its remote tracking branch. Returns 0 on success,&n; * -1 on failure.&n; */
DECL|function|get_rebase_fork_point
r_static
r_int
id|get_rebase_fork_point
c_func
(paren
r_int
r_char
...
multiline_comment|/**&n; * Sets merge_base to the octopus merge base of curr_head, merge_head and&n; * fork_point. Returns 0 if a merge base is found, 1 otherwise.&n; */
DECL|function|get_octopus_merge_base
r_static
r_int
id|get_octopus_merge_base
c_func
(paren
r_int
r_char
...
multiline_comment|/**&n; * Given the current HEAD SHA1, the merge head returned from git-fetch and the&n; * fork point calculated by get_rebase_fork_point(), runs git-rebase with the&n; * appropriate arguments and returns its exit status.&n; */
...
suffix:semicolon
multiline_comment|/* Options passed to git-rebase */
r_if
c_cond
(paren
id|opt_rebase
...
c_func
(paren
l_string|&quot;Updating an unborn branch with changes added to the index.&quot;
)paren
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Cannot rebase onto multiple branches.&quot;
)paren
)paren
suffix:semicolon
r_return
