...
mdefine_line|#define ACTION_GET_URLMATCH (1&lt;&lt;15)
...
c_func
(paren
l_string|&quot;read config from given blob object&quot;
)paren
)paren
comma
id|OPT_GROUP
...
c_func
(paren
l_string|&quot;get value specific for the URL: section[.var] URL&quot;
)paren
comma
id|ACTION_GET_URLMATCH
)paren
comma
id|OPT_BIT
c_func
...
c_func
(paren
l_string|&quot;find the color configured: slot [default]&quot;
)paren
comma
id|ACTION_GET_COLOR
)paren
...
c_func
(paren
l_string|&quot;find the color setting: slot [stdout-is-tty]&quot;
)paren
comma
...
c_func
(paren
l_string|&quot;show variable names only&quot;
)paren
)paren
comma
id|OPT_BOOL
...
r_else
(brace
multiline_comment|/* Just show the key name; back out delimiter */
r_if
c_cond
(paren
id|show_keys
...
c_func
(paren
l_string|&quot;BUG: cannot normalize type %d&quot;
comma
id|types
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;unable to parse default color value&quot;
)paren
)paren
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;writing config blobs is not supported&quot;
)paren
suffix:semicolon
)brace
DECL|struct|urlmatch_current_candidate_value
r_struct
id|urlmatch_current_candidate_value
(brace
...
DECL|function|default_user_config
r_static
r_char
op_star
...
c_func
(paren
l_string|&quot;--name-only is only applicable to --list or --get-regexp&quot;
)paren
suffix:semicolon
id|usage_with_options
c_func
...
c_func
(paren
l_string|&quot;editing blobs is not supported&quot;
)paren
suffix:semicolon
id|git_config
c_func
...
c_func
(paren
l_string|&quot;cannot create configuration file %s&quot;
)paren
comma
id|config_file
)paren
