...
c_func
(paren
l_string|&quot;git remote get-url [--push] [--all] &lt;name&gt;&quot;
)paren
comma
id|N_
c_func
...
op_star
r_const
id|builtin_remote_geturl_usage
(braket
)braket
op_assign
(brace
...
c_func
(paren
l_string|&quot;query push URLs rather than fetch URLs&quot;
)paren
)paren
comma
id|OPT_BOOL
...
multiline_comment|/* else fetch mode */
multiline_comment|/* Use the fetch URL when no push URLs were found or requested. */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;no URLs configured for remote &squot;%s&squot;&quot;
)paren
comma
id|remotename
)paren
