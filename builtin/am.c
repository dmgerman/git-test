...
id|SIGNOFF_EXPLICIT
multiline_comment|/* --signoff was set on the command-line */
)brace
suffix:semicolon
...
id|signoff
suffix:semicolon
multiline_comment|/* enum signoff_type */
DECL|member|utf8
r_int
id|utf8
suffix:semicolon
...
multiline_comment|/**&n; * For convenience to call write_file()&n; */
...
id|l1.buf
comma
l_string|&quot;# This series applies on GIT commit&quot;
)paren
)paren
(brace
id|ret
...
multiline_comment|/**&n; * This function only supports a single StGit series file in `paths`.&n; *&n; * Given an StGit series file, converts the StGit patches in the series into&n; * RFC2822 messages suitable for parsing with git-mailinfo, and queues them in&n; * the state directory.&n; *&n; * Returns 0 on success, -1 on failure.&n; */
DECL|function|split_mail_stgit_series
r_static
r_int
id|split_mail_stgit_series
c_func
(paren
r_struct
id|am_state
...
c_func
(paren
l_string|&quot;Only one StGIT patch series can be applied at once&quot;
)paren
)paren
suffix:semicolon
id|series_dir_buf
...
r_continue
suffix:semicolon
multiline_comment|/* skip comment lines */
id|argv_array_push
c_func
(paren
op_amp
...
multiline_comment|/**&n; * A split_patches_conv() callback that converts a mercurial patch to a RFC2822&n; * message suitable for parsing with git-mailinfo.&n; */
...
c_func
(paren
l_string|&quot;invalid timezone offset&quot;
)paren
)paren
suffix:semicolon
r_if
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * mercurial&squot;s timezone is in seconds west of UTC,&n;&t;&t;&t; * however git&squot;s timezone is in hours + minutes east of&n;&t;&t;&t; * UTC. Convert it.&n;&t;&t;&t; */
id|tz2
op_assign
id|labs
c_func
...
id|STRBUF_INIT
suffix:semicolon
multiline_comment|/* Does it end with our own sign-off? */
id|strbuf_addf
c_func
(paren
op_amp
...
m_exit
suffix:semicolon
multiline_comment|/* no need to duplicate */
multiline_comment|/* Does it have any Signed-off-by: in the text */
r_for
c_loop
(paren
id|cp
...
multiline_comment|/**&n; * Appends signoff to the &quot;msg&quot; field of the am_state.&n; */
DECL|function|am_append_signoff
r_static
r_void
id|am_append_signoff
c_func
(paren
r_struct
id|am_state
...
c_func
(paren
l_string|&quot;could not open output &squot;info&squot;&quot;
)paren
suffix:semicolon
r_if
c_cond
...
multiline_comment|/**&n; * Writes the diff of the index against HEAD as a patch to the state&n; * directory&squot;s &quot;patch&quot; file.&n; */
DECL|function|write_index_patch
r_static
r_void
id|write_index_patch
c_func
(paren
r_const
r_struct
...
multiline_comment|/**&n; * Do the three-way merge using fake ancestor, his tree constructed&n; * from the fake ancestor and the postimage of the patch, and our&n; * state.&n; */
DECL|function|run_fallback_merge_recursive
r_static
r_int
id|run_fallback_merge_recursive
c_func
(paren
r_const
r_struct
...
id|cp.env_array
comma
l_string|&quot;GIT_MERGE_VERBOSITY=0&quot;
)paren
suffix:semicolon
id|argv_array_push
c_func
...
multiline_comment|/**&n; * Interactively prompt the user on whether the current patch should be&n; * applied.&n; *&n; * Returns 0 if the user chooses to apply the patch, 1 if the user chooses to&n; * skip it.&n; */
...
c_func
(paren
l_string|&quot;cannot be interactive without stdin connected to a terminal.&quot;
)paren
)paren
suffix:semicolon
r_for
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * TRANSLATORS: Make sure to include [y], [n], [e], [v] and [a]&n;&t;&t; * in your translation. The program will only accept English&n;&t;&t; * input at this point.&n;&t;&t; */
id|reply
op_assign
id|git_prompt
c_func
...
c_func
(paren
l_string|&quot;Apply? [y]es/[n]o/[e]dit/[v]iew patch/[a]ccept all: &quot;
)paren
comma
id|PROMPT_ECHO
)paren
...
multiline_comment|/**&n; * Merges a tree into the index. The index&squot;s stat info will take precedence&n; * over the merged tree&squot;s. Returns 0 on success, -1 on failure.&n; */
