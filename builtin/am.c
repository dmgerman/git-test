...
multiline_comment|/**&n; * Like parse_mail(), but parses the mail by looking up its commit ID&n; * directly. This is used in --rebasing mode to bypass git-mailinfo&squot;s munging&n; * of patches.&n; *&n; * Will always return 0 as the patch should never be skipped.&n; */
