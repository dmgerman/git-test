...
c_func
(paren
l_string|&quot;record only the fact that removed paths will be added later&quot;
)paren
)paren
comma
id|OPT_END
...
(brace
multiline_comment|/* reset on unborn branch: treat as reset to empty tree */
id|hashcpy
c_func
(paren
id|oid.hash
...
c_func
(paren
l_string|&quot;-N can only be used with --mixed&quot;
)paren
)paren
suffix:semicolon
