...
suffix:semicolon
multiline_comment|/* Forward-compatibility cue: $GIT_CONFIG makes git read _only_&n;&t; * the given config file, $GIT_CONFIG_LOCAL will make it process&n;&t; * it in addition to the global config file, the same way it would&n;&t; * the per-repository config file otherwise. */
r_if
c_cond
(paren
id|getenv
