...
c_func
(paren
l_string|&quot;BUG: switch &squot;%c&squot; (--%s) %s&quot;
comma
id|opt-&gt;short_name
comma
id|opt-&gt;long_name
...
id|STRBUF_INIT
suffix:semicolon
multiline_comment|/*&n;&t; * Find the other option that was used to set the variable&n;&t; * already, and report that this is not compatible with it.&n;&t; */
r_for
c_loop
(paren
id|that
...
id|opt
comma
l_string|&quot;: incompatible with something else&quot;
comma
id|flags
)paren
suffix:semicolon
...
id|OPTION_CMDMODE
suffix:colon
multiline_comment|/*&n;&t;&t; * Giving the same mode option twice, although is unnecessary,&n;&t;&t; * is not a grave error, so let it pass.&n;&t;&t; */
r_if
c_cond
(paren
op_star
...
id|opt
comma
l_string|&quot;expects a non-negative integer value with an optional k/m/g suffix&quot;
comma
id|flags
)paren
suffix:semicolon
...
id|opts
comma
l_string|&quot;short name already used&quot;
)paren
suffix:semicolon
)brace
r_if
...
multiline_comment|/* lone -h asks for help */
r_if
c_cond
(paren
id|internal_help
