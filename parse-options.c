...
c_func
(paren
l_string|&quot;BUG: dashless options don&squot;t support arguments&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;BUG: dashless options don&squot;t support negation&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;BUG: dashless options can&squot;t be long&quot;
)paren
suffix:semicolon
r_if
c_cond
...
r_default
suffix:colon
multiline_comment|/* OPTION_{BIT,BOOLEAN,NUMBER,SET_INT,SET_PTR} */
r_break
suffix:semicolon
)brace
r_if
...
multiline_comment|/*&n; * This should really be OPTION_FILENAME type as a part of&n; * parse_options that take prefix to do this while parsing.&n; */
