...
l_string|&quot;&quot;
suffix:semicolon
multiline_comment|/* prepend/append * to the shell pattern: */
id|newpattern
op_assign
id|xmalloc
c_func
...
mdefine_line|#define MAX_SIGNATURE_LENGTH 1024
multiline_comment|/* message must be NULL or allocated, it will be reallocated and freed */
