...
op_assign
l_string|&quot;git-show-branch [--sparse] [--current] [--all] [--heads] [--tags] [--topo-order] [--more=count | --list | --independent | --merge-base ] [--topics] [&lt;refs&gt;...] | --reflog[=n] &lt;branch&gt;&quot;
suffix:semicolon
...
c_func
(paren
l_string|&quot;unrecognized reflog count &squot;%s&squot;&quot;
comma
id|arg
op_plus
l_int|9
