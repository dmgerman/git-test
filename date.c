...
c_func
(paren
l_string|&quot;BUG: cannot create anonymous strftime date_mode struct&quot;
)paren
suffix:semicolon
id|mode.type
op_assign
...
id|timebuf
comma
l_string|&quot;%04d-%02d-%02dT%02d:%02d:%02d%c%02d:%02d&quot;
comma
id|tm-&gt;tm_year
op_plus
l_int|1900
...
id|p
suffix:semicolon
multiline_comment|/* historical alias */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;date format missing colon separator: %s&quot;
comma
id|format
)paren
suffix:semicolon
