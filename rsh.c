...
multiline_comment|/*&n; * Write a shell-quoted version of a string into a buffer, and&n; * return bytes that ought to be output excluding final null.&n; */
...
c_func
(paren
l_string|&quot; !&bslash;&quot;#$%&amp;&bslash;&squot;()*;&lt;=&gt;?[&bslash;&bslash;]^`{|}&quot;
comma
id|ch
)paren
)paren
...
multiline_comment|/*&n; * Append a string to a string buffer, with or without quoting.  Return true&n; * if the buffer overflowed.&n; */
...
l_int|1
suffix:semicolon
multiline_comment|/* Overflow, string unusable */
)brace
op_star
id|ptrp
op_add_assign
