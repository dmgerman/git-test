...
(brace
multiline_comment|/* Sheesh, we really should make for-each-ref to take&n;&t; * callback data.&n;&t; */
op_star
id|cnt
op_assign
l_int|0
...
l_int|1
suffix:semicolon
multiline_comment|/* unspecified yet */
r_struct
id|refinfo
op_star
op_star
...
c_func
(paren
l_string|&quot;The number %s did not parse&quot;
comma
id|arg
)paren
suffix:semicolon
