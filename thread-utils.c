...
id|psd.psd_proc_cnt
suffix:semicolon
macro_line|#elif defined(HAVE_BSD_SYSCTL) &amp;&amp; defined(HW_NCPU)
r_int
id|mib
(braket
l_int|2
...
id|cpucount
suffix:semicolon
macro_line|#endif /* defined(HAVE_BSD_SYSCTL) &amp;&amp; defined(HW_NCPU) */
macro_line|#ifdef _SC_NPROCESSORS_ONLN
r_if
c_cond
(paren
