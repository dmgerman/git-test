...
multiline_comment|/*&n; * Turn&n; * &quot;pick d6a2f0303e897ec257dd0e0a39a5ccb709bc2047 some message&quot;&n; * into&n; * &quot;pick d6a2f03 some message&quot;&n; *&n; * The function assumes that the line does not contain useless spaces&n; * before or after the command.&n; */
DECL|function|abbrev_sha1_in_line
r_static
r_void
id|abbrev_sha1_in_line
c_func
(paren
r_struct
id|strbuf
...
id|abbrev
suffix:semicolon
multiline_comment|/*&n;&t;&t; * strbuf_split_max left a space. Trim it and re-add&n;&t;&t; * it after abbreviation.&n;&t;&t; */
id|strbuf_trim
c_func
(paren
id|split
...
DECL|function|read_rebase_todolist
r_static
r_void
id|read_rebase_todolist
c_func
(paren
r_const
r_char
...
c_func
(paren
l_string|&quot;Could not open file %s for reading&quot;
comma
id|git_path
c_func
(paren
...
DECL|function|show_rebase_information
r_static
r_void
id|show_rebase_information
c_func
(paren
r_struct
id|wt_status
...
c_func
(paren
l_string|&quot;rebase-merge/git-rebase-todo&quot;
comma
op_amp
id|yet_to_do
)paren
...
c_func
(paren
l_string|&quot;Last command done (%d command done):&quot;
comma
l_string|&quot;Last commands done (%d commands done):&quot;
comma
id|have_done.nr
)paren
comma
...
c_func
(paren
l_string|&quot;No commands remaining.&quot;
)paren
)paren
suffix:semicolon
r_else
...
c_func
(paren
l_string|&quot;Next command to do (%d remaining command):&quot;
comma
l_string|&quot;Next commands to do (%d remaining commands):&quot;
comma
id|yet_to_do.nr
)paren
comma
...
c_func
(paren
l_string|&quot;  (use &bslash;&quot;git rebase --edit-todo&bslash;&quot; to view and edit)&quot;
)paren
)paren
suffix:semicolon
)brace
...
DECL|function|print_rebase_state
r_static
r_void
id|print_rebase_state
c_func
(paren
r_struct
id|wt_status
