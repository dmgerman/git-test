...
c_func
(paren
l_string|&quot;send-pack: pipe failed&quot;
)paren
suffix:semicolon
id|pid
op_assign
...
(brace
multiline_comment|/*&n;&t;&t; * The child becomes pack-objects --revs; we feed&n;&t;&t; * the revision parameters to it via its stdin and&n;&t;&t; * let its stdout go back to the other end.&n;&t;&t; */
r_static
r_const
r_char
op_star
