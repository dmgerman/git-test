...
multiline_comment|/*&n; * Run &quot;rev-list --stdin | pack-objects&quot; pipe.&n; */
...
(brace
multiline_comment|/* The child becomes pack-objects; reads from pipe&n;&t;&t; * and writes to the original fd&n;&t;&t; */
id|dup2
c_func
(paren
id|pipe_fd
...
suffix:semicolon
multiline_comment|/* We become rev-list --stdin; output goes to pipe. */
id|dup2
c_func
(paren
id|pipe_fd
...
multiline_comment|/*&n; * Create &quot;rev-list --stdin | pack-objects&quot; pipe and feed&n; * the refs into the pipeline.&n; */
DECL|function|rev_list_generate
r_static
r_void
id|rev_list_generate
c_func
(paren
r_int
id|fd
...
c_func
(paren
l_string|&quot;rev-list-generate setup: pipe failed&quot;
)paren
suffix:semicolon
id|rev_list_generate_pid
op_assign
...
(brace
multiline_comment|/* The child becomes the &quot;rev-list | pack-objects&quot;&n;&t;&t; * pipeline.  It takes input from us, and its output&n;&t;&t; * goes to fd.&n;&t;&t; */
id|dup2
c_func
(paren
id|pipe_fd
...
c_func
(paren
l_string|&quot;rev-list-generate fork failed&quot;
)paren
suffix:semicolon
multiline_comment|/* We feed the rev parameters to them.  We do not write into&n;&t; * fd nor read from the pipe.&n;&t; */
id|close
c_func
(paren
id|pipe_fd
...
suffix:semicolon
singleline_comment|// waitpid(rev_list_generate_pid);
m_exit
(paren
l_int|0
)paren
...
id|stderr
comma
l_string|&quot;deleting &squot;%s&squot;&bslash;n&quot;
comma
id|ref-&gt;name
)paren
suffix:semicolon
