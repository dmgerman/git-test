...
id|fetch_recurse-&gt;util
suffix:semicolon
)brace
DECL|function|set_fetch_recurse_for_name
r_static
r_void
id|set_fetch_recurse_for_name
c_func
(paren
r_const
r_char
