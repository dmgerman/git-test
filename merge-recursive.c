...
DECL|macro|debug
mdefine_line|#define debug(...) fprintf(stderr, __VA_ARGS__)
macro_line|#else
DECL|macro|debug
mdefine_line|#define debug(...) do { ; /* nothing */ } while (0)
macro_line|#endif
macro_line|#ifdef DEBUG
...
suffix:semicolon
multiline_comment|/* avoid &quot;unused&quot; warning */
)brace
macro_line|#endif
...
c_func
(paren
l_string|&quot;  get_renames done in %ld&bslash;n&quot;
comma
id|time
c_func
(paren
