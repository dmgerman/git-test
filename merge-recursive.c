...
suffix:semicolon
multiline_comment|/* same as ren2-&gt;pair-&gt;two-&gt;path */
...
suffix:semicolon
id|ren1-&gt;dst_entry-&gt;involved_in_rename
op_assign
l_int|1
suffix:semicolon
)brace
