...
multiline_comment|/* Low-level merge functions */
...
op_star
id|ll_user_merge_fns
comma
op_star
op_star
id|ll_user_merge_fns_tail
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * merge.driver is a multi-valued configuration, whose value is&n;&t; * of form:&n;&t; *&n;&t; *&t;name command-line&n;&t; *&n;&t; * The command-line will be interpolated with the following&n;&t; * tokens and is given to the shell:&n;&t; *&n;&t; *    %O - temporary file name for the merge base.&n;&t; *    %A - temporary file name for our version.&n;&t; *    %B - temporary file name for the other branches&squot; version.&n;&t; *&n;&t; * The external merge driver should write the results in the file&n;&t; * named by %A, and signal that it has done with exit status 0.&n;&t; */
r_for
c_loop
(paren
id|nlen
...
c_func
(paren
l_string|&quot;%s &squot;%s&squot;: lacks command line&quot;
comma
id|var
comma
id|value
...
(brace
multiline_comment|/* Make sure we end at 100% */
r_if
c_cond
(paren
op_logical_neg
