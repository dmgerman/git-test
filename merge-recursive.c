...
multiline_comment|/*&n; * Per entry merge function for D/F conflicts, to be called only after&n; * all files below dir have been processed.  We do this because in the&n; * cases we can cleanly resolve D/F conflicts, process_entry() can clean&n; * out all the files below the directory for us.&n; */
...
l_int|1
suffix:semicolon
multiline_comment|/* we don&squot;t handle non D-F cases */
id|entry-&gt;processed
op_assign
l_int|1
suffix:semicolon
