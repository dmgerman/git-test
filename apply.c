...
op_assign
l_string|&quot;git-apply [--stat] [--numstat] [--summary] [--check] [--index] [--apply] [--no-add] [--index-info] [--allow-binary-replacement] [-z] [-pNUM] [-CNUM] [--whitespace=&lt;nowarn|warn|error|error-all|strip&gt;] &lt;patch&gt;...&quot;
suffix:semicolon
...
l_char|&squot;+&squot;
suffix:colon
multiline_comment|/*&n;&t;&t;&t; * We know len is at least two, since we have a &squot;+&squot; and&n;&t;&t;&t; * we checked that the last character was a &squot;&bslash;n&squot; above.&n;&t;&t;&t; * That is, an addition of an empty line would check&n;&t;&t;&t; * the &squot;+&squot; here.  Sneaky...&n;&t;&t;&t; */
r_if
c_cond
(paren
(paren
...
id|stderr
comma
l_string|&quot;Adds trailing whitespace.&bslash;n%s:%d:%.*s&bslash;n&quot;
comma
id|patch_input_file
comma
id|linenr
...
(brace
multiline_comment|/* plen is number of bytes to be copied from patch,&n;&t; * starting at patch+1 (patch[0] is &squot;+&squot;).  Typically&n;&t; * patch[plen] is &squot;&bslash;n&squot;.&n;&t; */
r_int
id|add_nl_to_tail
op_assign
l_int|0
...
macro_line|#ifdef NO_ACCURATE_DIFF
r_if
c_cond
(paren
id|oldsize
...
id|stderr
comma
l_string|&quot;Context reduced to (%ld/%ld) to apply fragment at %d&bslash;n&quot;
comma
id|leading
comma
id|trailing
...
suffix:semicolon
multiline_comment|/* For safety, we require patch index line to contain&n;&t;&t; * full 40-byte textual SHA1 for old and new, at least for now.&n;&t;&t; */
r_if
c_cond
(paren
id|strlen
...
id|hdrlen
suffix:semicolon
multiline_comment|/* See if the old one matches what the patch&n;&t;&t;&t; * applies to.&n;&t;&t;&t; */
...
multiline_comment|/* For now, we do not record post-image data in the patch,&n;&t;&t; * and require the object already present in the recipient&squot;s&n;&t;&t; * object database.&n;&t;&t; */
r_if
c_cond
(paren
id|desc-&gt;buffer
...
l_string|&quot;&squot;%s&squot; does not exist&quot;
comma
id|patch-&gt;new_sha1_prefix
comma
id|name
...
id|stderr
comma
l_string|&quot;warning: squelched %d whitespace error%s&bslash;n&quot;
comma
id|squelched
comma
id|squelched
