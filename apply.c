...
singleline_comment|//  --show-index-info shows the old and new index info for paths if available.
singleline_comment|//
...
op_assign
l_string|&quot;git-apply [--stat] [--summary] [--check] [--index] [--apply] [--show-files] [--show-index-info] &lt;patch&gt;...&quot;
suffix:semicolon
