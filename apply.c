...
op_assign
l_string|&quot;git-apply [--stat] [--numstat] [--summary] [--check] [--index] [--apply] [--no-add] [--index-info] [-z] &lt;patch&gt;...&quot;
suffix:semicolon
...
l_int|1
suffix:semicolon
multiline_comment|/* Empty patch cannot be applied if:&n;&t;&t; * - it is a binary patch or&n;&t;&t; * - metadata does not change and is not a binary patch.&n;&t;&t; */
r_if
c_cond
(paren
(paren
