...
c_func
(paren
l_string|&quot;the necessary preimage %s for &quot;
l_string|&quot;&squot;%s&squot; cannot be read&quot;
comma
id|patch-&gt;old_sha1_prefix
comma
...
suffix:semicolon
multiline_comment|/* patch-&gt;fragment-&gt;patch has the delta data and&n;&t;&t; * we should apply it to the preimage.&n;&t;&t; */
id|desc-&gt;buffer
op_assign
id|patch_delta
c_func
...
id|patch-&gt;fragments-&gt;patch
comma
id|patch-&gt;fragments-&gt;size
comma
op_amp
id|dst_size
)paren
