...
multiline_comment|/*&n;&t; * Run diff between two origins and grab the patch output, so that&n;&t; * we can pass blame for lines origin is currently suspected for&n;&t; * to its parent.&n;&t; */
id|fill_origin_blob
c_func
(paren
id|parent
