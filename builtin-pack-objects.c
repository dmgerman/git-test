...
mdefine_line|#define NR_THREADS&t;4
...
multiline_comment|/* this should be auto-tuned somehow */
id|chunk_size
op_assign
id|window
op_star
...
suffix:semicolon
id|data_requester-&gt;list
op_assign
id|list
suffix:semicolon
id|data_requester-&gt;list_size
op_assign
id|sublist_size
suffix:semicolon
id|pthread_mutex_unlock
...
mdefine_line|#define ll_find_deltas find_deltas
macro_line|#endif
