...
op_assign
l_string|&quot;&bslash;&n;git-pack-objects [{ -q | --progress | --all-progress }] [--max-pack-size=N] &bslash;n&bslash;&n;&t;[--local] [--incremental] [--window=N] [--depth=N] &bslash;n&bslash;&n;&t;[--no-reuse-delta] [--no-reuse-object] [--delta-base-offset] &bslash;n&bslash;&n;&t;[--non-empty] [--revs [--unpacked | --all]*] [--reflog] &bslash;n&bslash;&n;&t;[--stdout | base-name] [&lt;ref-list | &lt;object-list]&quot;
suffix:semicolon
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t;&t; * recover real object type in case&n;&t;&t;&t;&t; * check_object() wanted to re-use a delta,&n;&t;&t;&t;&t; * but we couldn&squot;t since base was in previous split pack&n;&t;&t;&t;&t; */
id|obj_type
op_assign
id|type
suffix:semicolon
...
multiline_comment|/* forward declarations for write_pack_file */
r_static
r_void
id|write_index_file
c_func
...
suffix:semicolon
multiline_comment|/* Write the actual SHA1 entries. */
id|list
op_assign
id|sorted_by_sha
suffix:semicolon
