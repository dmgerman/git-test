...
c_func
(paren
l_string|&quot;unable to point stderr to /dev/null&quot;
)paren
suffix:semicolon
)brace
r_while
...
op_assign
(brace
l_string|&quot;git-credential-cache--daemon [opts] &lt;socket_path&gt;&quot;
comma
l_int|NULL
)brace
suffix:semicolon
...
c_func
(paren
l_string|&quot;print debugging messages to stderr&quot;
)paren
)paren
comma
id|OPT_END
...
c_func
(paren
l_string|&quot;credentialcache.ignoresighup&quot;
comma
op_amp
id|ignore_sighup
)paren
