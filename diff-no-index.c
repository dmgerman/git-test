...
(brace
multiline_comment|/* 2 is file that is created */
id|d1
op_assign
id|noindex_filespec
c_func
...
r_else
(brace
multiline_comment|/* 1 is file that is deleted */
id|d1
op_assign
id|noindex_filespec
c_func
...
multiline_comment|/* emit that file */
id|diff_queue
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* and then let the entire directory be created or deleted */
)brace
r_if
c_cond
(paren
...
multiline_comment|/* append basename of F to D */
...
multiline_comment|/*&n; * DWIM &quot;diff D F&quot; into &quot;diff D/F F&quot; and &quot;diff F D&quot; into &quot;diff F D/F&quot;&n; * Note that we append the basename of F to D/, so &quot;diff a/b/file D&quot;&n; * becomes &quot;diff a/b/file D/file&quot;, not &quot;diff a/b/file D/a/b/file&quot;.&n; */
