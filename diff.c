...
l_string|&quot;&bslash;033[1m&quot;
comma
multiline_comment|/* METAINFO (bold) */
l_string|&quot;&bslash;033[36m&quot;
comma
multiline_comment|/* FRAGINFO (cyan) */
l_string|&quot;&bslash;033[31m&quot;
comma
multiline_comment|/* OLD (red) */
l_string|&quot;&bslash;033[32m&quot;
comma
multiline_comment|/* NEW (green) */
l_string|&quot;&bslash;033[33m&quot;
comma
multiline_comment|/* COMMIT (yellow) */
l_string|&quot;&bslash;033[41m&quot;
comma
multiline_comment|/* WHITESPACE (red background) */
)brace
suffix:semicolon
...
id|user_diff_tail
suffix:semicolon
multiline_comment|/*&n; * Currently there is only &quot;diff.&lt;drivername&gt;.command&quot; variable;&n; * because there are &quot;diff.color.&lt;slot&gt;&quot; variables, we are parsing&n; * this in a bit convoluted way to allow low level diff driver&n; * called &quot;color&quot;.&n; */
DECL|function|parse_lldiff_command
r_static
r_int
id|parse_lldiff_command
c_func
(paren
r_const
r_char
...
c_func
(paren
l_string|&quot;%s--- a/%s%s%s&bslash;n%s+++ b/%s%s%s&bslash;n%s@@ -&quot;
comma
id|metainfo
comma
id|name_a
...
id|current
suffix:semicolon
multiline_comment|/* output pointer */
DECL|member|suppressed_newline
r_int
id|suppressed_newline
suffix:semicolon
)brace
suffix:semicolon
...
id|xecfg.ctxlen
op_assign
id|diff_words-&gt;minus.alloc
op_plus
id|diff_words-&gt;plus.alloc
suffix:semicolon
id|ecb.outf
op_assign
id|xdiff_outf
...
suffix:semicolon
r_int
id|need_highlight_leading_space
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* The line is a newly added line.  Does it have funny leading&n;&t; * whitespaces?  In indent, SP should never precede a TAB.&n;&t; */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/* The whole line was indent */
id|emit_line
c_func
(paren
id|ws
...
(brace
multiline_comment|/* This has whitespace between tail+1..len */
id|fputs
c_func
(paren
id|set
...
multiline_comment|/* fall back to normal diff */
id|free_diff_words_data
c_func
(paren
id|ecbdata
...
(brace
multiline_comment|/*&n;&t; * make sure that at least one &squot;-&squot; is printed if there were deletions,&n;&t; * and likewise for &squot;+&squot;.&n;&t; */
r_if
c_cond
(paren
id|max_change
...
l_int|50
suffix:semicolon
multiline_comment|/* Sanity: give at least 5 columns to the graph,&n;&t; * but leave at least 10 columns for the name.&n;&t; */
r_if
c_cond
(paren
id|width
...
multiline_comment|/* Find the longest filename and max number of changes */
id|reset
op_assign
id|diff_get_color
c_func
...
(brace
multiline_comment|/* renames are already quoted by pprint_rename */
id|len
op_assign
id|quote_c_style
c_func
...
multiline_comment|/* Compute the width of the graph part;&n;&t; * 10 is for one blank at the beginning of the line plus&n;&t; * &quot; | count &quot; between the name and the graph.&n;&t; *&n;&t; * From here on, name_width is the width of the name area,&n;&t; * and width is the width of the graph area.&n;&t; */
id|name_width
op_assign
(paren
id|name_width
...
l_int|1
suffix:semicolon
multiline_comment|/* hunk header ident */
id|value
op_assign
id|attr_diff_check
(braket
...
op_star
id|hunk_header_regexp_list
comma
op_star
op_star
id|hunk_header_regexp_tail
suffix:semicolon
DECL|function|hunk_header_config
r_static
r_int
id|hunk_header_config
c_func
(paren
r_const
r_char
...
multiline_comment|/*&n;&t;&t; * If the config file has &quot;funcname.default&quot; defined, that&n;&t;&t; * regexp is used; otherwise NULL is returned and xemit uses&n;&t;&t; * the built-in default.&n;&t;&t; */
r_return
id|hunk_header_regexp
c_func
(paren
...
mdefine_line|#define INCREMENT 1024
r_char
op_star
id|buf
suffix:semicolon
...
id|DIFF_FORMAT_NO_OUTPUT
suffix:semicolon
id|options-&gt;exit_with_status
op_assign
l_int|1
suffix:semicolon
)brace
multiline_comment|/*&n;&t; * If we postprocess in diffcore, we cannot simply return&n;&t; * upon the first hit.  We need to run diff as usual.&n;&t; */
r_if
c_cond
(paren
id|options-&gt;pickaxe
