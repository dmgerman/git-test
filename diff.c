...
multiline_comment|/*&n; * Keep track of files used for diffing. Sometimes such an entry&n; * refers to a temporary file, sometimes to an existing file, and&n; * sometimes to &quot;/dev/null&quot;.&n; */
DECL|struct|diff_tempfile
r_static
r_struct
id|diff_tempfile
(brace
multiline_comment|/*&n;&t; * filename external diff should read from, or NULL if this&n;&t; * entry is currently not in use:&n;&t; */
DECL|member|name
r_const
r_char
op_star
...
suffix:semicolon
multiline_comment|/*&n;&t; * If this diff_tempfile instance refers to a temporary file,&n;&t; * this tempfile object is used to manage its lifetime.&n;&t; */
...
c_cond
(paren
id|ecbdata-&gt;opt-&gt;ws_error_highlight
op_amp
id|ws_error_highlight
)paren
(brace
...
c_func
(paren
l_string|&quot;BUG: stat option does not begin with --stat: %s&quot;
comma
id|arg
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;unknown value after ws-error-highlight=%.*s&quot;
comma
(paren
r_int
)paren
