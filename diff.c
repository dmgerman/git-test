...
r_continue
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Original minus copied is the removed material,&n;&t;&t; * added is the new material.  They are both damages&n;&t;&t; * made to the preimage. In --dirstat-by-file mode, count&n;&t;&t; * damaged files, not damaged lines. This is done by&n;&t;&t; * counting only a single damaged line per file.&n;&t;&t; */
id|damage
op_assign
(paren
id|p-&gt;one-&gt;size
...
id|data-&gt;o-&gt;file
comma
l_string|&quot;%s:%d: leftover conflict marker&bslash;n&quot;
comma
id|data-&gt;filename
comma
id|data-&gt;lineno
...
id|o-&gt;file
comma
l_string|&quot;%s:%d: ends with blank lines.&bslash;n&quot;
comma
id|data.filename
comma
id|data.trailing_blanks_start
