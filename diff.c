...
suffix:semicolon
multiline_comment|/* diff-delta does not like to do delta with empty, so&n;&t; * we do that by hand here.  Sigh...&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* literal copy can be done only 127-byte at a time.&n;&t;&t; */
id|bufsize
op_assign
id|dst_size
op_plus
...
(brace
multiline_comment|/* copy out literally */
r_while
c_loop
(paren
id|dst_size
...
c_func
(paren
l_string|&quot;unable to generate binary diff&quot;
)paren
suffix:semicolon
multiline_comment|/* emit delta encoded in base85 */
id|cp
op_assign
id|delta
suffix:semicolon
