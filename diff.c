...
multiline_comment|/*&n; * This function splits the words in buffer-&gt;text, and stores the list with&n; * newline separator into out.&n; */
...
c_func
(paren
l_string|&quot;error running textconv command &squot;%s&squot;&quot;
comma
id|pgm
)paren
suffix:semicolon
