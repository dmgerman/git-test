...
id|cmd
suffix:semicolon
multiline_comment|/* diff_cmd and diff_arg have 4 %s in total which makes&n;&t; * the sum of these strings 8 bytes larger than required.&n;&t; * we use 2 spaces around diff-opts, and we need to count&n;&t; * terminating NUL; we used to subtract 5 here, but we do not&n;&t; * care about small leaks in this subprocess that is about&n;&t; * to exec &quot;diff&quot; anymore.&n;&t; */
id|cmd_size
op_assign
(paren
id|strlen
...
multiline_comment|/* Un-quote the paths */
r_if
c_cond
(paren
id|label_path
