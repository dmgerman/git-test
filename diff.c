...
mdefine_line|#define MAX_SCORE 10000
DECL|macro|DEFAULT_MINIMUM_SCORE
mdefine_line|#define DEFAULT_MINIMUM_SCORE 5000
...
c_func
(paren
l_string|&quot;rename similarity index %d%%&bslash;n&quot;
comma
(paren
r_int
)paren
...
l_int|1
suffix:semicolon
multiline_comment|/* that is not -M option */
id|diglen
op_assign
id|strspn
c_func
