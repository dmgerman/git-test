...
(brace
multiline_comment|/*&n;&t; * We used to reject rename/copy but new diff-raw can express them.&n;&t; */
id|printf
c_func
(paren
l_string|&quot;:%06o %06o %s &quot;
...
l_int|1
suffix:semicolon
multiline_comment|/* not interesting */
