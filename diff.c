...
c_cond
(paren
id|one-&gt;driver-&gt;textconv_want_cache
op_logical_and
op_logical_neg
id|one-&gt;driver-&gt;textconv_cache
)paren
(brace
r_struct
id|notes_cache
...
id|msg
comma
l_string|&quot;&bslash;n%srename from &quot;
comma
id|line_prefix
)paren
suffix:semicolon
...
id|msg
comma
l_string|&quot;%sdissimilarity index %d%%&bslash;n&quot;
comma
id|line_prefix
comma
id|similarity_index
