...
multiline_comment|/* Blank line at EOF */
id|emit_line
c_func
(paren
id|ecbdata-&gt;file
...
l_int|0
suffix:semicolon
multiline_comment|/* starting where? */
id|at
op_assign
id|count_lines
c_func
...
l_int|1
suffix:semicolon
multiline_comment|/* the line number counts from 1 */
)brace
