...
id|diff_cmd
op_assign
l_string|&quot;diff -L&squot;%s%s%s&squot; -L&squot;%s%s%s&squot;&quot;
suffix:semicolon
r_const
r_char
op_star
...
id|cmd
suffix:semicolon
multiline_comment|/* diff_cmd and diff_arg have 8 %s in total which makes&n;&t; * the sum of these strings 16 bytes larger than required.&n;&t; * we use 2 spaces around diff-opts, and we need to count&n;&t; * terminating NUL, so we subtract 13 here.&n;&t; */
r_int
id|cmd_size
op_assign
(paren
