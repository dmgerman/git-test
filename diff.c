...
r_static
r_int
id|diff_dirstat_percent_default
op_assign
l_int|3
suffix:semicolon
...
c_func
(paren
l_string|&quot;Unknown --dirstat parameter &squot;%s&squot;&quot;
comma
id|p
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Missing comma separator at char &quot;
l_string|&quot;%&quot;
id|PRIuMAX
l_string|&quot; of &squot;%s&squot;&quot;
comma
(paren
r_uintmax
)paren
...
(brace
id|default_diff_options.dirstat_percent
op_assign
id|diff_dirstat_percent_default
suffix:semicolon
(paren
...
c_func
(paren
l_string|&quot;Failed to parse --dirstat/-X option parameter&quot;
)paren
suffix:semicolon
