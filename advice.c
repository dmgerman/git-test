...
l_string|&quot;as appropriate to mark resolution and make a commit.&quot;
)paren
)paren
suffix:semicolon
r_return
...
c_func
(paren
l_string|&quot;Exiting because of unfinished merge.&quot;
)paren
)paren
suffix:semicolon
)brace
