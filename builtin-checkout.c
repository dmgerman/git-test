...
multiline_comment|/*&n; * We really should allow cb_data... Yuck&n; */
...
l_int|0
suffix:semicolon
multiline_comment|/* not ours either */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/*&n;&t;&t; * Yeah, I know Christian&squot;s clean-up should&n;&t;&t; * be used here, but the topic is based on an&n;&t;&t; * older fork point.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;&squot;%s&squot; not string&quot;
comma
id|var
)paren
suffix:semicolon
