...
suffix:semicolon
multiline_comment|/* enough for dist=%d */
r_struct
id|object
op_star
id|obj
...
c_func
(paren
id|git_path_bisect_expected_rev
comma
...
suffix:semicolon
multiline_comment|/* XXX leak rev_argv, as &quot;revs&quot; may still be pointing to it */
)brace
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * bisect_common calls prepare_revision_walk right away, which&n;&t; * (together with .leak_pending = 1) makes us the sole owner of&n;&t; * the list of pending objects.&n;&t; */
id|bisect_common
c_func
(paren
op_amp
...
multiline_comment|/*&n; * The terms used for this bisect session are stored in BISECT_TERMS.&n; * We read them and store them to adapt the messages accordingly.&n; * Default is bad/good.&n; */
