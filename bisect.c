...
multiline_comment|/*&n; * This function runs the command &quot;git rev-list $_good ^$_bad&quot;&n; * and returns 1 if it produces some output, 0 otherwise.&n; */
...
c_func
(paren
l_string|&quot;Could not launch &squot;git rev-list&squot; command.&quot;
)paren
suffix:semicolon
id|rls_fout
op_assign
