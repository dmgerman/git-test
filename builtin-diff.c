...
multiline_comment|/* NEEDSWORK: struct object has place for name but we _do_&n; * know mode when we extracted the blob out of a tree, which&n; * we currently lose.&n; */
...
multiline_comment|/*&n;&t; * Make sure there are NO revision (i.e. pending object) parameter,&n;&t; * specified rev.max_count is reasonable (0 &lt;= n &lt;= 3), and&n;&t; * there is no other revision filtering parameter.&n;&t; */
r_if
c_cond
(paren
...
suffix:semicolon
multiline_comment|/* NEEDSWORK: shouldn&squot;t this part of diffopt??? */
id|diff_queue
c_func
(paren
op_amp
...
multiline_comment|/* We saw two trees, ent[0] and ent[1].&n;&t; * unless ent[0] is unintesting, they are swapped&n;&t; */
r_if
c_cond
(paren
id|ent
