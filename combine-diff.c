...
suffix:semicolon
multiline_comment|/* find set of paths that everybody touches&n;&t; *&n;&t; * NOTE find_paths() also handles --stat, as it computes&n;&t; * diff(sha1,parent_i) for all i to do the job, specifically&n;&t; * for parent0.&n;&t; */
id|paths
op_assign
id|find_paths
c_func
