...
suffix:semicolon
multiline_comment|/*&n;&t; * If we are adding new files, we need to scan the working&n;&t; * tree to find the ones that match pathspecs; this needs&n;&t; * to be done before we read the index.&n;&t; */
r_if
c_cond
(paren
id|add_new_files
