...
op_assign
l_string|&quot;git-cat-file [ [-t|-s|-e|-p|&lt;type&gt;] &lt;sha1&gt; | [--batch|--batch-check] &lt; &lt;list_of_sha1s&gt; ]&quot;
suffix:semicolon
...
c_func
(paren
l_string|&quot;git-cat-file: Can&squot;t use %s with -%c&quot;
comma
id|arg
comma
id|opt
...
c_func
(paren
l_string|&quot;git-cat-file: Can&squot;t use %s when a type (&bslash;&quot;%s&bslash;&quot;) is specified&quot;
comma
id|arg
comma
id|exp_type
...
c_func
(paren
l_string|&quot;git-cat-file: Can&squot;t use %s when an object (&bslash;&quot;%s&bslash;&quot;) is specified&quot;
comma
id|arg
comma
id|obj_name
...
c_func
(paren
l_string|&quot;git-cat-file: Can&squot;t use %s with %s&quot;
comma
id|arg
comma
id|is_batch
...
c_func
(paren
l_string|&quot;git-cat-file: Can&squot;t specify a type (&bslash;&quot;%s&bslash;&quot;) with %s&quot;
comma
id|arg
comma
id|batch
...
suffix:semicolon
singleline_comment|// We should have hit one of the earlier if (batch || batch_check) cases before
