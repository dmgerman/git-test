...
c_func
(paren
l_string|&quot;unable to write credential store&quot;
)paren
suffix:semicolon
)brace
...
multiline_comment|/*&n;&t; * Write credential to the filename specified by fns-&gt;items[0], thus&n;&t; * creating it&n;&t; */
r_if
c_cond
(paren
id|fns-&gt;nr
...
r_return
suffix:semicolon
multiline_comment|/* Found credential */
)brace
DECL|function|main
r_int
id|main
