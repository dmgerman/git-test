...
op_assign
l_string|&quot;git-pickaxe [-c] [-l] [-t] [-f] [-n] [-p] [-L n,m] [-S &lt;revs-file&gt;] [-M] [commit] [--] file&bslash;n&quot;
...
l_string|&quot;  -M                  Find line movements within the file&bslash;n&quot;
...
multiline_comment|/*&n; * One blob in a commit&n; */
DECL|struct|origin
r_struct
id|origin
(brace
...
id|stderr
comma
l_string|&quot;get patch %.8s %.8s&bslash;n&quot;
comma
id|sha1_to_hex
c_func
(paren
...
id|stderr
comma
l_string|&quot;plno = %d, tlno = %d, &quot;
l_string|&quot;same as parent up to %d, resync %d and %d&bslash;n&quot;
comma
id|plno
comma
id|tlno
...
suffix:semicolon
multiline_comment|/* tlno to chunk-&gt;same are the same as ent */
r_if
c_cond
(paren
id|ent-&gt;num_lines
...
id|porigin
suffix:semicolon
multiline_comment|/* now everything blamed for origin is blamed for&n;&t;&t;&t; * porigin, we do not need to keep it anymore.&n;&t;&t;&t; * Do not free porigin (or the ones we got from&n;&t;&t;&t; * earlier round); they may still be used elsewhere.&n;&t;&t;&t; */
id|free_origin
c_func
(paren
id|origin
...
suffix:semicolon
multiline_comment|/* if (unk == 1) we could be getting&n;&t;&t;&t;&t; * old-style&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|unk
