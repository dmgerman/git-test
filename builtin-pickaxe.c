...
mdefine_line|#define cmp_suspect(a, b) ( ((a)==(b)) ? 0 : cmp_suspect(a,b) )
r_static
r_void
...
id|DIFF_FORMAT_NO_OUTPUT
suffix:semicolon
multiline_comment|/* Try &quot;find copies harder&quot; on new path */
r_if
c_cond
(paren
(paren
...
id|DIFF_DETECT_COPY
suffix:semicolon
id|diff_opts.find_copies_harder
op_assign
l_int|1
suffix:semicolon
)brace
...
suffix:semicolon
multiline_comment|/* The first pass looks for unrenamed path to optimize for&n;&t; * common cases, then we look for renames in the second pass.&n;&t; */
r_for
c_loop
(paren
id|pass
...
(brace
multiline_comment|/* then pick each and see if they have the the correct&n;&t;&t; * refcnt; note that -&gt;util caching means origin&squot;s refcnt&n;&t;&t; * may well be greater than the number of blame entries&n;&t;&t; * that use it.&n;&t;&t; */
r_int
id|found
suffix:semicolon
r_struct
