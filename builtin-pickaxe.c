...
id|porigin
suffix:semicolon
multiline_comment|/* Otherwise we would look for a rename */
id|diff_setup
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/*&n;&t; * NEEDSWORK: This loop is wasteful in that it opens the same&n;&t; * blob in the parent number of times.  We should swap the&n;&t; * loop inside out, which would require keeping track of&n;&t; * &quot;best blame so far&quot; for blame entries that the current&n;&t; * &quot;target&quot; is being suspected.&n;&t; */
r_for
c_loop
(paren
id|e
