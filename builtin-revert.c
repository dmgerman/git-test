...
id|revert_usage
op_assign
l_string|&quot;git-revert [--edit | --no-edit] [-n] &lt;commit-ish&gt;&quot;
suffix:semicolon
...
op_assign
l_string|&quot;git-cherry-pick [--edit] [-n] [-r] [-x] &lt;commit-ish&gt;&quot;
suffix:semicolon
DECL|variable|edit
r_static
r_int
...
id|arg
comma
l_string|&quot;--i-really-want-&quot;
l_string|&quot;to-expose-my-private-commit-object-name&quot;
)paren
)paren
id|replay
op_assign
...
id|die
(paren
l_string|&quot;Cannot %s a root commit&quot;
comma
id|me
)paren
suffix:semicolon
...
id|die
(paren
l_string|&quot;Cannot %s a multi-parent commit.&quot;
comma
id|me
)paren
suffix:semicolon
