...
r_return
suffix:semicolon
multiline_comment|/* Only single-parent commits don&squot;t have TREECHANGE */
op_star
id|pp
op_assign
id|p-&gt;parents-&gt;item
...
multiline_comment|/*&n;&t; * Ok, the commit wasn&squot;t uninteresting. If it&n;&t; * is a merge, try to find the parent that has&n;&t; * no differences in the path set if one exists.&n;&t; */
r_if
c_cond
(paren
id|paths
...
id|list-&gt;next
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Exactly one parent? Check if it leaves the tree&n;&t;&t; * unchanged&n;&t;&t; */
r_if
c_cond
(paren
id|parent
