...
c_func
(paren
l_string|&quot;Insanely long encoding name %s&quot;
comma
id|encoding
)paren
suffix:semicolon
...
r_char
op_star
id|end_of_encoding_header
suffix:semicolon
r_int
id|encoding_header_pos
suffix:semicolon
r_int
id|encoding_header_len
suffix:semicolon
r_int
id|new_len
suffix:semicolon
...
id|buf_p
suffix:semicolon
multiline_comment|/*&n;&t; * We do not want to repeatedly realloc below, so&n;&t; * preallocate with enough slop to hold MIME headers,&n;&t; * &quot;Subject: &quot; prefix, etc.&n;&t; */
id|slop
op_assign
l_int|1000
suffix:semicolon
...
r_break
suffix:semicolon
multiline_comment|/* 20 would cover indent and leave us some slop */
r_if
c_cond
(paren
id|offset
...
c_func
(paren
l_string|&quot;Encoding name %s too long&quot;
comma
id|encoding
)paren
suffix:semicolon
...
l_char|&squot;&bslash;n&squot;
suffix:semicolon
multiline_comment|/*&n;&t; * make sure there is another EOLN to separate the headers from whatever&n;&t; * body the caller appends if we haven&squot;t already written a body&n;&t; */
r_if
c_cond
(paren
id|fmt
