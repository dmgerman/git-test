...
multiline_comment|/* Clear out the Range: header after performing the request, so&n;&t;   other curl requests don&squot;t inherit inappropriate header data */
id|curl_result
op_assign
...
c_func
(paren
l_string|&quot;unable to write index filename %s: %s&quot;
comma
id|filename
comma
id|strerror
...
c_func
(paren
l_string|&quot;unable to write pack filename %s: %s&quot;
comma
id|filename
comma
id|strerror
...
suffix:semicolon
multiline_comment|/* Note: if another instance starts now, it will turn our new&n;&t;   tmpfile into its prevfile. */
r_if
c_cond
(paren
id|local
