...
macro_line|#ifndef NO_EXPAT
macro_line|#include &lt;expat.h&gt;
multiline_comment|/* Definitions for DAV requests */
...
multiline_comment|/* Definitions for processing XML DAV responses */
...
c_func
(paren
l_string|&quot;Unable to start PROPFIND request&quot;
)paren
suffix:semicolon
)brace
id|free
