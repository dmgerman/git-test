...
id|len
suffix:semicolon
multiline_comment|/*&n;&t; * strftime reports &quot;0&quot; if it could not fit the result in the buffer.&n;&t; * Unfortunately, it also reports &quot;0&quot; if the requested time string&n;&t; * takes 0 bytes. So if we were to probe and grow, we have to choose&n;&t; * some arbitrary cap beyond which we guess that the format probably&n;&t; * just results in a 0-length output. Since we have to choose some&n;&t; * reasonable cap anyway, and since it is not that big, we may&n;&t; * as well just grow to their in the first place.&n;&t; */
id|strbuf_grow
c_func
(paren
id|sb
...
(brace
multiline_comment|/*&n;&t;&t; * Either we failed, or the format actually produces a 0-length&n;&t;&t; * output. There&squot;s not much we can do, so we leave it blank.&n;&t;&t; * However, the output array is left in an undefined state, so&n;&t;&t; * we must re-assert our NUL terminator.&n;&t;&t; */
id|sb-&gt;buf
(braket
id|sb-&gt;len
)braket
