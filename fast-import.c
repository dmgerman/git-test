...
id|to
suffix:semicolon
multiline_comment|/* yes this is a layering violation */
id|pack_file-&gt;total
op_assign
id|to
suffix:semicolon
...
id|pack_size
suffix:semicolon
multiline_comment|/* preserve the pack_file SHA1 ctx in case we have to truncate later */
id|sha1flush
c_func
(paren
id|pack_file
