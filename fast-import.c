...
r_static
r_int
id|import_marks_file_ignore_missing
suffix:semicolon
...
r_static
r_int
id|require_explicit_termination
suffix:semicolon
multiline_comment|/* Signal handling */
DECL|variable|checkpoint_requested
r_static
r_volatile
id|sig_atomic_t
id|checkpoint_requested
suffix:semicolon
multiline_comment|/* Where to write output of cat-blob commands */
...
macro_line|#ifndef SIGUSR1&t;/* Windows, for example */
DECL|function|set_checkpoint_signal
r_static
r_void
id|set_checkpoint_signal
c_func
(paren
r_void
)paren
...
id|o
suffix:semicolon
multiline_comment|/* Build the table of object IDs. */
id|idx
op_assign
id|xmalloc
c_func
...
r_return
suffix:semicolon
multiline_comment|/* Marks file does not exist */
r_else
id|die_errno
c_func
(paren
...
c_func
(paren
l_string|&quot;Missing space before &lt; in ident string: %s&quot;
comma
id|buf
)paren
suffix:semicolon
...
multiline_comment|/*&n; * Given a pointer into a string, parse a mark reference:&n; *&n; *   idnum ::= &squot;:&squot; bigint;&n; *&n; * Return the first character after the value in *endptr.&n; *&n; * Complain if the following character is not what is expected,&n; * either a space or end of the string.&n; */
...
c_func
(paren
l_string|&quot;No value after &squot;:&squot; in mark: %s&quot;
comma
id|command_buf.buf
)paren
suffix:semicolon
...
multiline_comment|/*&n; * Parse the mark reference, and complain if this is not the end of&n; * the string.&n; */
DECL|function|parse_mark_ref_eol
r_static
r_uintmax
id|parse_mark_ref_eol
c_func
(paren
r_const
r_char
...
multiline_comment|/*&n; * Parse the mark reference, demanding a trailing space.  Return a&n; * pointer to the space.&n; */
DECL|function|parse_mark_ref_space
r_static
r_uintmax
id|parse_mark_ref_space
c_func
(paren
r_const
r_char
...
c_func
(paren
l_string|&quot;Missing space after mark: %s&quot;
comma
id|command_buf.buf
)paren
suffix:semicolon
...
multiline_comment|/* Git does not track empty, non-toplevel directories. */
r_if
c_cond
(paren
id|S_ISDIR
...
c_func
(paren
l_string|&quot;Directories cannot be specified &squot;inline&squot;: %s&quot;
comma
id|command_buf.buf
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Not a %s (actually a %s): %s&quot;
comma
r_typename
(paren
id|expected
...
(brace
multiline_comment|/* C &quot;path/to/subdir&quot; &quot;&quot; */
id|tree_content_replace
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;Can&squot;t add a note on empty branch.&quot;
)paren
suffix:semicolon
id|hashcpy
c_func
...
c_func
(paren
l_string|&quot;Write to frontend failed&quot;
)paren
suffix:semicolon
)brace
...
multiline_comment|/*&n;&t; * Output based on batch_one_object() from cat-file.c.&n;&t; */
r_if
c_cond
(paren
id|type
...
c_func
(paren
l_string|&quot;Can&squot;t read object %s&quot;
comma
id|sha1_to_hex
c_func
(paren
...
c_func
(paren
l_string|&quot;Object %s is a %s but a blob was expected.&quot;
comma
id|sha1_to_hex
c_func
(paren
...
suffix:semicolon
multiline_comment|/* get-mark SP &lt;object&gt; LF */
r_if
c_cond
(paren
op_star
...
suffix:semicolon
multiline_comment|/* cat-blob SP &lt;object&gt; LF */
r_if
c_cond
(paren
op_star
...
(brace
multiline_comment|/* in a pack being written */
id|buf
op_assign
id|gfi_unpack_entry
c_func
...
c_func
(paren
l_string|&quot;Can&squot;t load object %s&quot;
comma
id|sha1_to_hex
c_func
(paren
...
suffix:semicolon
multiline_comment|/* Peel one layer. */
r_switch
c_cond
(paren
id|oe-&gt;type
...
c_func
(paren
l_string|&quot;Invalid SHA1 in tag: %s&quot;
comma
id|command_buf.buf
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Invalid SHA1 in commit: %s&quot;
comma
id|command_buf.buf
)paren
suffix:semicolon
...
id|STRBUF_INIT
suffix:semicolon
multiline_comment|/* See show_tree(). */
r_const
r_char
op_star
id|type
...
(brace
multiline_comment|/* missing SP path LF */
id|strbuf_reset
c_func
(paren
op_amp
...
r_else
(brace
multiline_comment|/* mode SP type SP object_name TAB path LF */
id|strbuf_reset
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/*&n;&t; * A directory in preparation would have a sha1 of zero&n;&t; * until it is saved.  Save, for simplicity.&n;&t; */
r_if
c_cond
(paren
id|S_ISDIR
...
c_func
(paren
l_string|&quot;%s: argument must be a non-negative integer&quot;
comma
id|option
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;--cat-blob-fd cannot exceed %d&quot;
comma
id|INT_MAX
)paren
suffix:semicolon
...
id|feature
comma
l_string|&quot;import-marks-if-exists=&quot;
comma
op_amp
id|arg
)paren
...
(brace
suffix:semicolon
multiline_comment|/* Don&squot;t die - this feature is supported */
)brace
r_else
r_if
c_cond
...
(brace
r_int
id|indexversion_value
suffix:semicolon
r_int
r_int
id|packsizelimit_value
suffix:semicolon
r_if
c_cond
(paren
