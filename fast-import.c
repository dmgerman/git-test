...
suffix:semicolon
multiline_comment|/* round out how much we map to 16 MB units */
id|pack_mlen
op_assign
id|pack_size
suffix:semicolon
...
c_func
(paren
l_string|&quot;Error from zlib during inflate.&quot;
)paren
suffix:semicolon
)brace
id|inflateEnd
...
id|sp
suffix:semicolon
multiline_comment|/* Obtain the new branch name from the rest of our command */
id|sp
op_assign
id|strchr
c_func
...
c_func
(paren
l_string|&quot;An lf did not terminate the branch command as expected.&quot;
)paren
suffix:semicolon
)brace
...
op_assign
l_string|&quot;git-fast-import [--objects=n] [--depth=n] [--active-branches=n] temp.pack&quot;
suffix:semicolon
DECL|function|main
r_int
id|main
