...
(brace
multiline_comment|/* Must be unique; i.e. when heads/foo and&n;&t;&t;&t; * tags/foo are both present, reject &quot;foo&quot;.&n;&t;&t;&t; */
r_if
c_cond
(paren
l_int|1
...
multiline_comment|/* We want to allow .git/description file and&n;&t;&t; * &quot;description&quot; branch to exist at the same time.&n;&t;&t; * &quot;git-rev-parse description&quot; should silently skip&n;&t;&t; * .git/description file as a candidate for&n;&t;&t; * get_sha1().  However, having garbage file anywhere&n;&t;&t; * under refs/ is not OK, and we would not have caught&n;&t;&t; * ambiguous heads and tags with the above test.&n;&t;&t; */
r_else
r_if
c_cond
(paren
...
(brace
multiline_comment|/* Garbage exists under .git/refs */
r_return
id|error
c_func
(paren
l_string|&quot;garbage ref found &squot;%s&squot;&quot;
comma
id|pathname
)paren
suffix:semicolon
