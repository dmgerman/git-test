...
multiline_comment|/*&n; * *string and *len will only be substituted, and *string returned (for&n; * later free()ing) if the string passed in is of the form @{-&lt;n&gt;} or&n; * of the form &lt;branch&gt;@{upstream}.&n; */
...
id|die
(paren
l_string|&quot;No tracking branch found for &squot;%s&squot;&quot;
comma
id|ref
)paren
suffix:semicolon
