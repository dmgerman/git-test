...
multiline_comment|/*&n; * This reads &quot;@{-N}&quot; syntax, finds the name of the Nth previous&n; * branch we were on, and places the name of the branch in the given&n; * buf and returns 0 if successful.&n; *&n; * If the input is not of the accepted format, it returns a negative&n; * number to signal an error.&n; */
