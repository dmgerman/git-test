...
r_static
r_int
id|disambiguate_committish_only
c_func
(paren
r_const
r_int
...
l_int|0
suffix:semicolon
multiline_comment|/* We need to do this the hard way... */
id|obj
op_assign
id|deref_tag
c_func
...
c_func
(paren
l_string|&quot;Git normally never creates a ref that ends with 40 hex characters&bslash;n&quot;
l_string|&quot;because it will be ignored when you just specify 40-hex. These refs&bslash;n&quot;
l_string|&quot;may be created by mistake. For example,&bslash;n&quot;
l_string|&quot;&bslash;n&quot;
l_string|&quot;  git checkout -b $br $(git rev-parse ...)&bslash;n&quot;
l_string|&quot;&bslash;n&quot;
...
multiline_comment|/* parse @something syntax, when &squot;something&squot; is not {.*} */
DECL|function|interpret_empty_at
r_static
r_int
id|interpret_empty_at
c_func
(paren
r_const
r_char
...
suffix:semicolon
multiline_comment|/*&n;&t; * Upstream can be NULL only if branch refers to HEAD and HEAD&n;&t; * points to something different than a branch.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
id|flags
op_amp
id|GET_SHA1_FOLLOW_SYMLINKS
)paren
(brace
id|ret
op_assign
id|get_tree_entry_follow_symlinks
c_func
(paren
id|tree_sha1
comma
...
c_func
(paren
l_string|&quot;BUG: incompatible flags for get_sha1_with_context&quot;
)paren
suffix:semicolon
r_return
id|get_sha1_with_context_1
