...
macro_line|#ifndef NEEDS_ALIGNED_ACCESS
DECL|macro|ntoh_s
mdefine_line|#define ntoh_s(var) ntohs(var)
DECL|macro|ntoh_l
mdefine_line|#define ntoh_l(var) ntohl(var)
macro_line|#else
DECL|function|ntoh_s_force_align
r_static
r_inline
r_uint16
id|ntoh_s_force_align
c_func
(paren
r_void
op_star
...
DECL|macro|ntoh_s
mdefine_line|#define ntoh_s(var) ntoh_s_force_align(&amp;(var))
DECL|macro|ntoh_l
mdefine_line|#define ntoh_l(var) ntoh_l_force_align(&amp;(var))
macro_line|#endif
