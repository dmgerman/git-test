...
multiline_comment|/*&n; * Note: the rest of the rename logic depends on this&n; * phase also populating all the filespecs for any&n; * entry that isn&squot;t matched up with an exact rename.&n; */
...
id|p-&gt;next
suffix:semicolon
multiline_comment|/* Stupid special case, see note above! */
id|diff_populate_filespec
c_func
(paren
id|entry-&gt;filespec
