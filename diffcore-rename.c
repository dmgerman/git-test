...
multiline_comment|/*&n; * Returns 0 on success, -1 if we found a duplicate.&n; */
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * Find the best source match for specified destination.&n;&t; */
id|best
op_assign
l_int|NULL
suffix:semicolon
...
id|file_table
suffix:semicolon
multiline_comment|/* Add all sources to the hash table */
id|hashmap_init
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* Walk the destinations and find best source match */
r_for
c_loop
(paren
id|i
...
suffix:semicolon
multiline_comment|/* Free the hash data structure and entries */
id|hashmap_free
c_func
(paren
op_amp
...
multiline_comment|/*&n; * Returns:&n; * 0 if we are under the limit;&n; * 1 if we need to disable inexact rename detection;&n; * 2 if we would be under the limit if we were given -C instead of -C -C.&n; */
DECL|function|too_many_rename_candidates
r_static
r_int
id|too_many_rename_candidates
c_func
(paren
r_int
id|num_create
...
id|num_create
suffix:semicolon
multiline_comment|/* Are we running under -C -C? */
r_if
c_cond
(paren
op_logical_neg
...
l_int|1
suffix:semicolon
multiline_comment|/* Would we bust the limit if we were running under -C? */
r_for
c_loop
(paren
id|num_src
