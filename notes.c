...
multiline_comment|/* note: takes ownership of path string */
...
multiline_comment|/*&n; * Add the lines from the named object to list, with trailing&n; * newlines removed.&n; */
...
multiline_comment|/*&n;&t; * If the last line of the file is EOL-terminated, this will&n;&t; * add an empty string to the list.  But it will be removed&n;&t; * later, along with any empty strings that came from empty&n;&t; * lines within the file.&n;&t; */
...
r_return
suffix:semicolon
multiline_comment|/* we&squot;re happy */
r_else
r_if
c_cond
(paren
