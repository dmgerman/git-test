...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * This is safe because either --format and/or --output must&n;&t;&t; * have been given on the original command line if we get to&n;&t;&t; * this point, and parse_options() must have eaten at least&n;&t;&t; * one argument, i.e. we have enough room to append to argv[].&n;&t;&t; */
id|argv
(braket
id|argc
op_increment
