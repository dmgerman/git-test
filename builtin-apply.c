...
op_assign
l_string|&quot;git-apply [--stat] [--numstat] [--summary] [--check] [--index] [--cached] [--apply] [--no-add] [--index-info] [--allow-binary-replacement] [-z] [-pNUM] [-CNUM] [--whitespace=&lt;nowarn|warn|error|error-all|strip&gt;] &lt;patch&gt;...&quot;
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Grab the type of patch */
id|llen
op_assign
id|linelen
c_func
...
c_func
(paren
l_string|&quot;unrecognized binary patch at line %d: %.*s&quot;
comma
id|linenr
op_minus
l_int|1
