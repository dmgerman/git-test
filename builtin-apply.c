...
multiline_comment|/*&n;&t;&t; * Count lines added at the end of the file.&n;&t;&t; * This is not enough to get things right in case of&n;&t;&t; * patches generated with --unified=0, but it&squot;s a&n;&t;&t; * useful upper bound.&n;&t;&t;*/
r_if
c_cond
(paren
id|first
...
(brace
multiline_comment|/* Any added empty lines is already cleaned-up here&n;&t;&t; * becuase of &squot;strip_whitespace&squot; flag, so just count &squot;&bslash;n&squot;&n;&t;&t;*/
r_int
id|empty
op_assign
l_int|0
...
op_decrement
suffix:semicolon
multiline_comment|/* these are the empty lines added at&n;&t;&t; * the end of the file, modulo u0 patches.&n;&t;&t; */
id|trailing_added_lines
op_assign
id|empty
suffix:semicolon
