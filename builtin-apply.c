...
id|fixed_preimage
suffix:semicolon
multiline_comment|/*&n;&t; * Adjust the common context lines in postimage, in place.&n;&t; * This is possible because whitespace fixing does not make&n;&t; * the string grow.&n;&t; */
r_new
op_assign
id|old
op_assign
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Do we have an exact match?  If we were told to match&n;&t; * at the end, size must be exactly at try+fragsize,&n;&t; * otherwise try+fragsize must be still within the preimage,&n;&t; * and either case, the old piece should match the preimage&n;&t; * exactly.&n;&t; */
r_if
c_cond
(paren
(paren
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * The hunk does not apply byte-by-byte, but the hash says&n;&t; * it might with whitespace fuzz.&n;&t; */
id|fixed_buf
op_assign
id|xmalloc
c_func
...
id|fixlen
suffix:semicolon
multiline_comment|/* length after fixing the preimage */
r_int
id|oldlen
op_assign
id|preimage-&gt;line
...
id|tgtfixlen
suffix:semicolon
multiline_comment|/* length after fixing the target line */
r_char
id|tgtfixbuf
(braket
l_int|1024
...
(brace
multiline_comment|/*&n;&t;&t;&t; * If the patch application adds blank lines&n;&t;&t;&t; * at the end, and if the patch applies at the&n;&t;&t;&t; * end of the image, remove those added blank&n;&t;&t;&t; * lines.&n;&t;&t;&t; */
r_while
c_loop
(paren
id|new_blank_lines_at_end
