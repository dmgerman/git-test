...
c_func
(paren
l_string|&quot;http.maxrequestbuffer&quot;
comma
op_amp
id|max_request_buffer
)paren
...
multiline_comment|/*&n; * This is basically strbuf_read(), except that if we&n; * hit max_request_buffer we die (we&squot;d rather reject a&n; * maliciously large request than chew up infinite memory).&n; */
...
multiline_comment|/* partial read from read_in_full means we hit EOF */
id|len
op_add_assign
id|cnt
suffix:semicolon
...
multiline_comment|/* otherwise, grow and try again (if we can) */
r_if
c_cond
(paren
id|alloc
...
c_func
(paren
l_string|&quot;request was larger than our maximum size (%lu);&quot;
l_string|&quot; try setting GIT_HTTP_MAX_REQUEST_BUFFER&quot;
comma
id|max_request_buffer
)paren
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* nothing left to read */
r_else
id|n
op_assign
id|read_request
...
c_func
(paren
l_string|&quot;error reading request body&quot;
)paren
suffix:semicolon
r_if
c_cond
...
suffix:semicolon
id|set_die_is_recursing_routine
c_func
(paren
id|die_webcgi_recursing
)paren
...
c_func
(paren
l_string|&quot;GIT_HTTP_MAX_REQUEST_BUFFER&quot;
comma
id|max_request_buffer
)paren
suffix:semicolon
