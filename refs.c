...
id|flag
suffix:semicolon
multiline_comment|/* ISSYMREF? ISPACKED? ISPEELED? */
DECL|member|sha1
r_int
r_char
id|sha1
...
(brace
multiline_comment|/* &quot;SHA-1 SP SP refs/tags/tagname^{} LF&quot;? */
id|line
op_increment
suffix:semicolon
id|len
...
multiline_comment|/* older pack-refs did not leave peeled ones in */
)brace
...
(brace
multiline_comment|/* The ref did not exist and we are creating it.&n;&t;&t; * Make sure there is no existing ref that is packed&n;&t;&t; * whose name begins with our refname, nor a ref whose&n;&t;&t; * name is a proper prefix of our refname.&n;&t;&t; */
r_int
id|namlen
op_assign
id|strlen
