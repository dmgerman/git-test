...
c_func
(paren
l_string|&quot;Reference has invalid name: &squot;%s&squot;&quot;
comma
id|refname
)paren
suffix:semicolon
...
multiline_comment|/*&n; * Write sha1 as the new value of the reference specified by the&n; * (open) lock. On error, roll back the lockfile and set errno&n; * appropriately.&n; */
...
id|err
comma
l_string|&quot;refusing to create ref with bad name %s&quot;
comma
id|refname
)paren
suffix:semicolon
