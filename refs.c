...
multiline_comment|/* merge sort the ref list */
...
multiline_comment|/*&n; * Return a pointer to a cached_refs for the specified submodule. For&n; * the main repository, use submodule==NULL. The returned structure&n; * will be allocated and initialized but not necessarily populated; it&n; * should not be freed.&n; */
...
suffix:semicolon
r_else
multiline_comment|/* For now, don&squot;t reuse the refs cache for submodules. */
id|clear_cached_refs
c_func
(paren
id|submodule_refs
