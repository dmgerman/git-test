...
multiline_comment|/*&n; * Return true iff a reference named refname could be created without&n; * conflicting with the name of an existing reference in dir.  If&n; * oldrefname is non-NULL, ignore potential conflicts with oldrefname&n; * (e.g., because oldrefname is scheduled for deletion in the same&n; * operation).&n; *&n; * Two reference names conflict if one of them exactly matches the&n; * leading components of the other; e.g., &quot;foo/bar&quot; conflicts with&n; * both &quot;foo&quot; and with &quot;foo/bar/baz&quot; but not with &quot;foo/bar&quot; or&n; * &quot;foo/barbados&quot;.&n; */
...
(brace
multiline_comment|/*&n;&t;&t; * We are still at a leading dir of the refname; we are&n;&t;&t; * looking for a conflict with a leaf entry.&n;&t;&t; *&n;&t;&t; * If we find one, we still must make sure it is&n;&t;&t; * not &quot;oldrefname&quot;.&n;&t;&t; */
id|pos
op_assign
id|search_ref_dir
c_func
...
(brace
multiline_comment|/*&n;&t;&t; * We found a directory named &quot;refname&quot;. It is a&n;&t;&t; * problem iff it contains any ref that is not&n;&t;&t; * &quot;oldrefname&quot;.&n;&t;&t; */
r_struct
id|ref_entry
op_star
id|entry
