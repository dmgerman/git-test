...
multiline_comment|/*&n; * How to handle various characters in refnames:&n; * This table is used by both the SIMD and non-SIMD code.  It has&n; * some cases that are only useful for the SIMD; these are handled&n; * equivalently to the listed disposition in the non-SIMD code.&n; * 0: An acceptable character for refs&n; * 1: @, look for a following { to reject @{ in refs (SIMD or = 0)&n; * 2: &bslash;0: End-of-component and string&n; * 3: /: End-of-component (SIMD or = 2)&n; * 4: ., look for a preceding . to reject .. in refs&n; * 5: {, look for a preceding @ to reject @{ in refs&n; * 6: *, usually a bad character except, once as a wildcard (SIMD or = 7)&n; * 7: A bad character except * (see check_refname_component below)&n; */
...
r_static
r_int
id|check_refname_format_bytewise
c_func
(paren
r_const
r_char
...
macro_line|#if defined(__GNUC__) &amp;&amp; defined(__x86_64__)
DECL|macro|SSE_VECTOR_BYTES
mdefine_line|#define SSE_VECTOR_BYTES 16
multiline_comment|/* Vectorized version of check_refname_format. */
...
suffix:semicolon
multiline_comment|/* below &squot;*&squot;, all characters are forbidden or rare */
r_const
id|__m128i
id|star_ub
op_assign
...
suffix:semicolon
multiline_comment|/* &squot;[&squot;..&squot;^&squot; contains 4 characters: 3 forbidden and 1 rare */
r_const
id|__m128i
id|bracket_lb
op_assign
...
suffix:semicolon
multiline_comment|/* &squot;~&squot; and above are forbidden */
r_const
id|__m128i
id|tilde_lb
op_assign
...
(brace
multiline_comment|/* entirely empty ref or initial ref component */
r_return
l_int|1
suffix:semicolon
)brace
multiline_comment|/*&n;&t; * Initial ref component of &squot;.&squot;; below we look for /. so we&squot;ll&n;&t; * miss this.&n;&t; */
r_if
c_cond
(paren
id|refname
...
multiline_comment|/*&n;&t;&t;&t; * End-of-page; fall back to slow method for&n;&t;&t;&t; * this entire ref.&n;&t;&t;&t; */
r_return
id|check_refname_format_bytewise
c_func
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * This range (note the lt) contains some&n;&t;&t; * permissible-but-rare characters (including all&n;&t;&t; * characters &gt;= 128), which we handle later.  It also&n;&t;&t; * includes &bslash;000.&n;&t;&t; */
id|result
op_assign
id|_mm_cmplt_epi8
c_func
...
suffix:semicolon
multiline_comment|/* This range contains the permissible ] as bycatch */
id|result
op_assign
id|_mm_or_si128
c_func
...
suffix:semicolon
multiline_comment|/* .l, beginning of .lock */
id|result
op_assign
id|_mm_or_si128
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Even though /. is not necessarily an error, we flag&n;&t;&t; * it anyway. If we find it, we&squot;ll check if it&squot;s valid&n;&t;&t; * and if so we&squot;ll advance just past it.&n;&t;&t; */
id|result
op_assign
id|_mm_or_si128
c_func
...
(brace
multiline_comment|/*&n;&t;&t;&t; * We&squot;ve found either end-of-string, or some&n;&t;&t;&t; * probably-bad character or substring.&n;&t;&t;&t; */
r_int
id|i
op_assign
id|__builtin_ctz
...
l_int|5
suffix:colon
multiline_comment|/*&n;&t;&t;&t;&t; * bycatch: a good character that&squot;s in&n;&t;&t;&t;&t; * one of the ranges of mostly-forbidden&n;&t;&t;&t;&t; * characters&n;&t;&t;&t;&t; */
id|cp
op_add_assign
id|i
op_plus
...
op_increment
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * Even if leading dots are allowed, don&squot;t&n;&t;&t;&t;&t; * allow &quot;.&quot; as a component (&quot;..&quot; is&n;&t;&t;&t;&t; * prevented by case 4 below).&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|cp
...
(brace
multiline_comment|/* skip to just after the /. */
id|cp
op_add_assign
id|i
op_plus
...
l_int|1
suffix:semicolon
multiline_comment|/* .lock as end-of-component or end-of-string */
r_if
c_cond
(paren
(paren
...
id|REFNAME_REFSPEC_PATTERN
suffix:semicolon
multiline_comment|/* restart after the * */
id|cp
op_add_assign
id|i
op_plus
