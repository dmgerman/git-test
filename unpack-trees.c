...
id|info-&gt;data
suffix:semicolon
multiline_comment|/* merging two or more trees with an identical subdirectory? */
r_if
c_cond
(paren
(paren
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Instead of descending into the directory, keep the contents&n;&t; * of the current index.&n;&t; */
r_while
c_loop
(paren
l_int|1
...
r_break
suffix:semicolon
multiline_comment|/* Is the entry still in that directory? */
r_if
c_cond
(paren
id|do_compare_entry
...
r_break
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Note: we do not just run unpack_index_entry() here,&n;&t;&t; * as the callback may want to compare what is in the&n;&t;&t; * index with what are from the HEAD and the other tree&n;&t;&t; * and reject the merge.  We pretend that ancestors, the&n;&t;&t; * HEAD and the other tree all have the same contents as&n;&t;&t; * the current index, which is a lie, but it works.&n;&t;&t; */
r_for
c_loop
(paren
id|i
...
l_char|&squot;/&squot;
suffix:semicolon
multiline_comment|/* included, no clearing for any entries under this directory */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* excluded, clear all selected entries under this directory. */
r_if
c_cond
(paren
id|ret
