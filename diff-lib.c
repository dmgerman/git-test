...
multiline_comment|/*&n; * Count how many index entries go with the first one&n; */
...
l_int|1
suffix:semicolon
multiline_comment|/* We can only have multiple entries if the first one is not stage-0 */
r_if
c_cond
(paren
id|ce_stage
