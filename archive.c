...
suffix:semicolon
multiline_comment|/* no trailing slash */
id|ret
op_assign
id|write_directory
c_func
...
DECL|function|queue_or_write_archive_entry
r_static
r_int
id|queue_or_write_archive_entry
c_func
(paren
r_const
r_int
...
c_func
(paren
l_string|&quot;uploadarchive.allowunreachable&quot;
comma
op_amp
id|remote_allow_unreachable
)paren
