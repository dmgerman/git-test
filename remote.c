...
(brace
singleline_comment|// we always fetch &quot;refs/*:refs/*&quot;, which is trivial
id|add_fetch_refspec
c_func
(paren
id|ret
...
multiline_comment|/*&n; * Returns true if, under the matching rules for fetching, name is the&n; * same as the given full name.&n; */
DECL|function|ref_matches_abbrev
r_static
r_int
id|ref_matches_abbrev
c_func
(paren
r_const
r_char
...
c_func
(paren
l_string|&quot;Couldn&squot;t find remote ref %s&bslash;n&quot;
comma
id|name
)paren
suffix:semicolon
