...
suffix:semicolon
multiline_comment|/*&n;&t; * The branches file would have URL and optionally&n;&t; * #branch specified.  The &quot;master&quot; (or specified) branch is&n;&t; * fetched and stored in the local branch of the same name.&n;&t; */
id|frag
op_assign
id|strchr
c_func
