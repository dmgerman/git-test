...
l_int|0
suffix:semicolon
multiline_comment|/* new object must be commit-ish */
id|o
op_assign
id|deref_tag
c_func
...
multiline_comment|/*&n;&t;&t; * The below logic determines whether an individual&n;&t;&t; * refspec A:B can be pushed.  The push will succeed&n;&t;&t; * if any of the following are true:&n;&t;&t; *&n;&t;&t; * (1) the remote reference B does not exist&n;&t;&t; *&n;&t;&t; * (2) the remote reference B is being removed (i.e.,&n;&t;&t; *     pushing :B where no source is specified)&n;&t;&t; *&n;&t;&t; * (3) the update meets all fast-forwarding criteria:&n;&t;&t; *&n;&t;&t; *     (a) the destination is not under refs/tags/&n;&t;&t; *     (b) the old is a commit&n;&t;&t; *     (c) the new is a descendant of the old&n;&t;&t; *&n;&t;&t; *     NOTE: We must actually have the old object in&n;&t;&t; *     order to overwrite it in the remote reference,&n;&t;&t; *     and the new object must be commit-ish.  These are&n;&t;&t; *     implied by (b) and (c) respectively.&n;&t;&t; *&n;&t;&t; * (4) it is forced using the +A:B notation, or by&n;&t;&t; *     passing the --force argument&n;&t;&t; */
