...
comma
l_string|&quot;git notes add [-f] [-m &lt;msg&gt; | -F &lt;file&gt; | (-c | -C) &lt;object&gt;] [&lt;object&gt;]&quot;
comma
l_string|&quot;git notes copy [-f] &lt;from-object&gt; &lt;to-object&gt;&quot;
comma
l_string|&quot;git notes append [-m &lt;msg&gt; | -F &lt;file&gt; | (-c | -C) &lt;object&gt;] [&lt;object&gt;]&quot;
comma
...
l_string|&quot;command&quot;
comma
l_string|&quot;load rewriting config for &lt;command&gt; (implies --stdin)&quot;
)paren
comma
id|OPT_END
c_func
...
c_func
(paren
l_string|&quot;cannot use -m/-F/-c/-C options with %s subcommand.&quot;
comma
id|argv
(braket
l_int|0
...
c_func
(paren
l_string|&quot;cannot use --for-rewrite with %s subcommand.&quot;
comma
id|argv
(braket
l_int|0
...
c_func
(paren
l_string|&quot;cannot use --stdin with %s subcommand.&quot;
comma
id|argv
(braket
l_int|0
...
c_func
(paren
l_string|&quot;Cannot %s notes. Found existing notes for object&quot;
...
c_func
(paren
l_string|&quot;Missing notes on source object %s. Cannot copy.&quot;
comma
id|sha1_to_hex
c_func
(paren
