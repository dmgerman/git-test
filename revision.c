...
id|list
suffix:semicolon
multiline_comment|/*&n;&t;&t; * rev_info.reverse is used to note the fact that we&n;&t;&t; * want to output the list of revisions in reverse&n;&t;&t; * order.  To accomplish this goal, reverse can have&n;&t;&t; * different values:&n;&t;&t; *&n;&t;&t; *  0  do nothing&n;&t;&t; *  1  reverse the list&n;&t;&t; *  2  internal use:  we have already obtained and&n;&t;&t; *     reversed the list, now we only need to yield&n;&t;&t; *     its items.&n;&t;&t; */
r_if
c_cond
(paren
id|revs-&gt;reverse
...
multiline_comment|/* all remaining commits are boundary commits */
id|revs-&gt;max_count
op_assign
l_int|1
suffix:semicolon
