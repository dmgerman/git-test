...
suffix:semicolon
r_int
id|after_slash_or_colon
suffix:semicolon
multiline_comment|/* Guess dir name from repository: strip trailing &squot;/&squot;,&n;&t; * strip trailing &squot;[:/]*.{git,bundle}&squot;, strip leading &squot;.*[/:]&squot;. */
id|after_slash_or_colon
op_assign
l_int|1
suffix:semicolon
