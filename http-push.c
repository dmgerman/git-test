...
id|stderr
comma
l_string|&quot;HEAD HTTP error %ld&bslash;n&quot;
comma
id|results.http_code
)paren
suffix:semicolon
...
id|stderr
comma
l_string|&quot;Unable to start HEAD request&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|free
...
c_func
(paren
l_string|&quot;Unable to start remote symref request&quot;
)paren
suffix:semicolon
)brace
id|free
...
suffix:semicolon
multiline_comment|/*&n;&t; * Create a minimum remote by hand to give to http_init(),&n;&t; * primarily to allow it to look at the URL.&n;&t; */
id|remote
op_assign
id|xcalloc
c_func
