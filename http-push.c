...
id|current_time
suffix:semicolon
multiline_comment|/* Refresh all active locks if they&squot;re close to expiring */
r_for
c_loop
(paren
id|lock
...
suffix:semicolon
multiline_comment|/* Make sure the url is not already locked */
r_while
c_loop
(paren
id|lock
