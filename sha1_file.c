...
suffix:semicolon
multiline_comment|/* something like &quot;.git/objects/pack/xxxxx.pack&quot; */
...
multiline_comment|/* Returns 0 on fast-path success, returns 1 on deltified&n; * and need to unpack to see info.&n; */
...
suffix:semicolon
multiline_comment|/* This may recursively unpack the base, which is what we want */
id|base
op_assign
id|read_sha1_file
c_func
