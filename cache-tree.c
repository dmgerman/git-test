...
l_int|0
suffix:semicolon
multiline_comment|/* not strictly needed */
id|it-&gt;down
(braket
id|it-&gt;subtree_nr
op_increment
...
suffix:semicolon
multiline_comment|/* 0 1 2 3 4 5&n;&t;&t;&t; *       ^     ^subtree_nr = 6&n;&t;&t;&t; *       i&n;&t;&t;&t; * move 4 and 5 up one place (2 entries)&n;&t;&t;&t; * 2 = 6 - 3 - 1 = subtree_nr - i - 1&n;&t;&t;&t; */
id|memmove
c_func
(paren
id|it-&gt;down
...
suffix:semicolon
multiline_comment|/* the cache checksum of the corresponding index file. */
id|memcpy
c_func
(paren
id|buffer
...
(brace
multiline_comment|/* check the cache-tree matches the index */
r_if
c_cond
(paren
id|memcmp
...
l_int|NULL
suffix:semicolon
multiline_comment|/* checksum mismatch */
r_if
c_cond
(paren
id|buffer
