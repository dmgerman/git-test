...
c_func
(paren
l_string|&quot;BUG: is_inside_git_dir called before setup_git_directory&quot;
)paren
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;BUG: is_inside_work_tree called before setup_git_directory&quot;
)paren
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;Cannot change directory to $%s &squot;%s&squot;&quot;
comma
id|GIT_DIR_ENVIRONMENT
comma
id|gitdirenv
...
suffix:semicolon
multiline_comment|/*&n;&t; * In case there is a work tree we may change the directory,&n;&t; * therefore make GIT_DIR an absolute path.&n;&t; */
r_if
c_cond
(paren
id|gitdirenv
...
c_func
(paren
l_string|&quot;$%s too big after expansion to absolute path&quot;
comma
id|GIT_DIR_ENVIRONMENT
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Cannot change directory to working tree &squot;%s&squot;&quot;
l_string|&quot; from $%s&quot;
comma
id|gitworktree
comma
