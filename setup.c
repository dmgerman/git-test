...
multiline_comment|/*&n; * If no worktree was given, and we are outside of a default work tree,&n; * now is the time to set it.&n; *&n; * In other words, if the user calls git with something like&n; *&n; *&t;git --git-dir=/some/where/else/.git bla&n; *&n; * default to /some/where/else as working directory; if the specified&n; * git-dir does not end in &quot;/.git&quot;, the cwd is used as working directory.&n; */
...
l_int|1
suffix:semicolon
multiline_comment|/* strip the variable &squot;dir&squot; of the postfix &quot;/.git&quot; if it has it */
id|len
op_assign
id|strlen
c_func
...
c_func
(paren
l_string|&quot;directory name too long&quot;
)paren
suffix:semicolon
id|memcpy
c_func
...
suffix:semicolon
multiline_comment|/* are we inside the default work tree? */
id|rel
op_assign
id|get_relative_cwd
c_func
...
multiline_comment|/* if rel is set, the cwd is _not_ the current working tree */
r_if
c_cond
(paren
id|rel
...
suffix:semicolon
multiline_comment|/*&n;&t; * Test in the following order (relative to the cwd):&n;&t; * - .git/&n;&t; * - ./ (bare)&n;&t; * - ../.git/&n;&t; * - ../ (bare)&n;&t; * - ../../.git/&n;&t; *   etc.&n;&t; */
id|offset
op_assign
id|len
op_assign
