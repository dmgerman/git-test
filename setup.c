...
multiline_comment|/*&n; * A &quot;string_list_each_func_t&quot; function that canonicalizes an entry&n; * from GIT_CEILING_DIRECTORIES using real_path_if_valid(), or&n; * discards it if unusable.&n; */
