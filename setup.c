...
(brace
multiline_comment|/*&n;&t;&t; * record any known extensions here; otherwise,&n;&t;&t; * we fall through to recording it as unknown, and&n;&t;&t; * check_repository_format will complain&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;unknown repository extension: %s&quot;
comma
id|unknown_extensions.items
(braket
l_int|0
)braket
dot
