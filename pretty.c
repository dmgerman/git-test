...
(brace
multiline_comment|/*&n;&t;&t; * RFC 2047, section 5 (3):&n;&t;&t; *&n;&t;&t; * Each &squot;encoded-word&squot; MUST represent an integral number of&n;&t;&t; * characters.  A multi-octet character may not be split across&n;&t;&t; * adjacent &squot;encoded- word&squot;s.&n;&t;&t; */
r_const
r_int
r_char
op_star
...
suffix:semicolon
multiline_comment|/* &quot;=%02X&quot; * chrlen, or the byte itself */
r_const
r_char
op_star
id|encoded_fmt
...
(brace
multiline_comment|/* It won&squot;t fit with trailing &quot;?=&quot; --- break the line */
id|strbuf_addf
c_func
(paren
id|sb
...
id|mailbuf
op_assign
id|pp-&gt;from_ident-&gt;mail_begin
suffix:semicolon
id|maillen
op_assign
id|pp-&gt;from_ident-&gt;mail_end
id|mailbuf
suffix:semicolon
id|namebuf
op_assign
id|pp-&gt;from_ident-&gt;name_begin
suffix:semicolon
id|namelen
op_assign
id|pp-&gt;from_ident-&gt;name_end
id|namebuf
suffix:semicolon
)brace
id|strbuf_addstr
...
multiline_comment|/* the next value means &quot;wide enough to that column&quot; */
r_if
c_cond
(paren
op_star
...
l_int|7
suffix:semicolon
multiline_comment|/* consumed 7 bytes, &quot;C(auto)&quot; */
)brace
r_else
(brace
r_int
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * Otherwise, we decided to treat %C&lt;unknown&gt;&n;&t;&t;&t; * as a literal string, and the previous&n;&t;&t;&t; * %C(auto) is still valid.&n;&t;&t;&t; */
r_return
id|ret
suffix:semicolon
)brace
...
c_cond
(paren
id|c-&gt;signature_check.gpg_output
)paren
id|strbuf_addstr
c_func
(paren
...
multiline_comment|/* check for trailing ansi sequences */
r_if
c_cond
(paren
op_star
...
r_break
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * got a good ansi sequence, put it back to&n;&t;&t;&t; * local_sb as we&squot;re cutting sb&n;&t;&t;&t; */
id|strbuf_insert
c_func
(paren
op_amp
...
l_int|2
suffix:semicolon
multiline_comment|/*&n;&t;&t; * we calculate padding in columns, now&n;&t;&t; * convert it back to chars&n;&t;&t; */
id|padding
op_assign
id|padding
id|len
...
c_func
(paren
id|context.signature_check.gpg_output
)paren
suffix:semicolon
id|free
c_func
(paren
id|context.signature_check.signer
)paren
suffix:semicolon
)brace
