...
suffix:semicolon
multiline_comment|/*&n;&t; * There is no checked out .gitattributes file there, but&n;&t; * we might have it in the index.  We allow operation in a&n;&t; * sparsely checked out work tree, so read from it.&n;&t; */
id|buf
op_assign
id|read_index_data
c_func
