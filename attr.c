...
comma
op_amp
id|res-&gt;u.pat.patternlen
comma
op_amp
id|res-&gt;u.pat.flags
comma
op_amp
id|res-&gt;u.pat.nowildcardlen
)paren
suffix:semicolon
r_if
c_cond
...
op_assign
(brace
l_string|&quot;[attr]binary -diff -merge -text&quot;
comma
l_int|NULL
comma
)brace
...
multiline_comment|/*&n; * Collect attributes for path into the array pointed to by&n; * check_all_attr. If num is non-zero, only attributes in check[] are&n; * collected. Otherwise all attributes are collected.&n; */
DECL|function|collect_some_attrs
r_static
r_void
id|collect_some_attrs
c_func
(paren
r_const
r_char
...
suffix:semicolon
multiline_comment|/* Count the number of attributes that are set. */
id|count
op_assign
l_int|0
suffix:semicolon
