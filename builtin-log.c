...
suffix:semicolon
multiline_comment|/*&n;&t; * We can only do diffstat with a unique reference point, and&n;&t; * log is a bit tricky, so just skip it.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* Multiple origins don&squot;t work for diffstat. */
r_if
c_cond
(paren
id|negative_count
