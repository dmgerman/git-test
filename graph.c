...
id|graph
suffix:semicolon
id|opt-&gt;diffopt.output_prefix_length
op_assign
l_int|0
suffix:semicolon
r_return
...
r_return
suffix:semicolon
multiline_comment|/*&n;&t; * When showing a diff of a merge against each of its parents, we&n;&t; * are called once for each parent without graph_update having been&n;&t; * called.  In this case, simply output a single padding line.&n;&t; */
r_if
c_cond
(paren
id|graph_is_commit_finished
