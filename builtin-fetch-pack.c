...
multiline_comment|/* xd[] is talking with upload-pack; subprocess reads from&n;&t; * xd[0], spits out band#2 to stderr, and feeds us band#1&n;&t; * through demux-&gt;out.&n;&t; */
id|demux-&gt;proc
op_assign
id|sideband_demux
suffix:semicolon
