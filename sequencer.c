...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * If index_unchanged is less than 0, that indicates we either&n;&t;&t; * couldn&squot;t parse HEAD or the index, so error out here.&n;&t;&t; */
r_if
c_cond
(paren
id|index_unchanged
...
multiline_comment|/*&n;&t;&t;&t; * The head tree and the index match&n;&t;&t;&t; * meaning the commit is empty.  Since it wasn&squot;t created&n;&t;&t;&t; * empty (based on the previous test), we can conclude&n;&t;&t;&t; * the commit has been made redundant.  Since we don&squot;t&n;&t;&t;&t; * want to keep redundant commits, we can just return&n;&t;&t;&t; * here, skipping this commit&n;&t;&t;&t; */
r_return
l_int|0
suffix:semicolon
r_if
