...
DECL|function|feed_msg_to_hook
r_static
r_int
id|feed_msg_to_hook
c_func
...
DECL|function|feed_obj_to_hook
r_static
r_int
id|feed_obj_to_hook
c_func
...
DECL|function|run_post_upload_pack_hook
r_static
r_int
id|run_post_upload_pack_hook
c_func
(paren
r_int
id|total
...
op_assign
l_string|&quot;hooks/post-upload-pack&quot;
suffix:semicolon
id|argv
(braket
l_int|1
...
id|proc.in
comma
l_string|&quot;time %ld.%06ld&bslash;n&quot;
comma
(paren
r_int
)paren
...
suffix:semicolon
multiline_comment|/* pass on revisions we (don&squot;t) want */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;post-upload-hook failed&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
