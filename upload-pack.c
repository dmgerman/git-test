...
(brace
multiline_comment|/* Pipes between rev-list to pack-objects and pack-objects to us. */
r_int
id|lp_pipe
(braket
l_int|2
...
suffix:semicolon
multiline_comment|/* We read from pu_pipe[0] to capture the pack data.&n;&t; */
id|close
c_func
(paren
id|pu_pipe
...
c_func
(paren
l_string|&quot;git-upload-pack: aborting due to possible repository corruption on the remote side.&quot;
)paren
suffix:semicolon
)brace
